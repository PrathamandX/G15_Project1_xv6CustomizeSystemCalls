...
forktest(void)
{
  ...
  36:	45e50513          	addi	a0,a0,1118 # 490 <thread_id+0xe>
  ...
  58:	48c50513          	addi	a0,a0,1164 # 4e0 <thread_id+0x5e>
  ...
  6e:	43650513          	addi	a0,a0,1078 # 4a0 <thread_id+0x1e>
  ...
  80:	43c50513          	addi	a0,a0,1084 # 4b8 <thread_id+0x36>
  ...
  b0:	42450513          	addi	a0,a0,1060 # 4d0 <thread_id+0x4e>
...
stat(const char *n, struct stat *st)
{
 ...
 226:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 228:	85ca                	mv	a1,s2
 22a:	1a0000ef          	jal	3ca <fstat>
 22e:	892a                	mv	s2,a0
  close(fd);
 230:	8526                	mv	a0,s1
 232:	168000ef          	jal	39a <close>
  return r;
 236:	64a2                	ld	s1,8(sp)
}
 238:	854a                	mv	a0,s2
...
000000000000042a <mutex_acquire>:
...
0000000000000432 <mutex_release>:
...
000000000000045a <ismyear>:
.global ismyear
ismyear:
 li a7, SYS_ismyear
 45a:	02000893          	li	a7,32
 ecall
 45e:	00000073          	ecall
 ret
 462:	8082                	ret

0000000000000464 <thread_create>:
.global thread_create
thread_create:
 li a7, SYS_thread_create
 464:	02100893          	li	a7,33
 ecall
 468:	00000073          	ecall
 ret
 46c:	8082                	ret

000000000000046e <thread_join>:
.global thread_join
thread_join:
 li a7, SYS_thread_join
 46e:	02200893          	li	a7,34
 ecall
 472:	00000073          	ecall
 ret
 476:	8082                	ret

0000000000000478 <thread_exit>:
.global thread_exit
thread_exit:
 li a7, SYS_thread_exit
 478:	02300893          	li	a7,35
 ecall
 47c:	00000073          	ecall
 ret
 480:	8082                	ret

0000000000000482 <thread_id>:
.global thread_id
thread_id:
 li a7, SYS_thread_id
 482:	02400893          	li	a7,36
 ecall
 486:	00000073          	ecall
 ret
 48a:	8082                	ret
