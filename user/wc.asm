...
wc(int fd, char *name)
{
  ...
  3c:	a18a0a13          	addi	s4,s4,-1512 # a50 <malloc+0x102>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	9d250513          	addi	a0,a0,-1582 # a70 <malloc+0x122>
  a6:	7f4000ef          	jal	89a <printf>
}
  ...
  cc:	99850513          	addi	a0,a0,-1640 # a60 <malloc+0x112>
  d0:	7ca000ef          	jal	89a <printf>
    exit(1);
  d4:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
 ...
 136:	92658593          	addi	a1,a1,-1754 # a58 <malloc+0x10a>
 13a:	4501                	li	a0,0
 ...
 14e:	93650513          	addi	a0,a0,-1738 # a80 <malloc+0x132>
 152:	748000ef          	jal	89a <printf>
      exit(1);
 156:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 2ac:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 2ae:	85ca                	mv	a1,s2
 2b0:	1a0000ef          	jal	450 <fstat>
 2b4:	892a                	mv	s2,a0
  close(fd);
 2b6:	8526                	mv	a0,s1
 2b8:	168000ef          	jal	420 <close>
  return r;
 2bc:	64a2                	ld	s1,8(sp)
}
 2be:	854a                	mv	a0,s2
...
00000000000004b0 <mutex_acquire>:
...
00000000000004b8 <mutex_release>:
...
00000000000004ea <thread_create>:
.global thread_create
thread_create:
 li a7, SYS_thread_create
 4ea:	02100893          	li	a7,33
 ecall
 4ee:	00000073          	ecall
 ret
 4f2:	8082                	ret

00000000000004f4 <thread_join>:
.global thread_join
thread_join:
 li a7, SYS_thread_join
 4f4:	02200893          	li	a7,34
 ecall
 4f8:	00000073          	ecall
 ret
 4fc:	8082                	ret

00000000000004fe <thread_exit>:
.global thread_exit
thread_exit:
 li a7, SYS_thread_exit
 4fe:	02300893          	li	a7,35
 ecall
 502:	00000073          	ecall
 ret
 506:	8082                	ret

0000000000000508 <thread_id>:
.global thread_id
thread_id:
 li a7, SYS_thread_id
 508:	02400893          	li	a7,36
 ecall
 50c:	00000073          	ecall
 ret
 510:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 54e:	55650513          	addi	a0,a0,1366 # aa0 <digits>
 552:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7e4:	2c0b8b93          	addi	s7,s7,704 # aa0 <digits>
 ...
 846:	25690913          	addi	s2,s2,598 # a98 <malloc+0x14a>
        for(; *s; s++)
