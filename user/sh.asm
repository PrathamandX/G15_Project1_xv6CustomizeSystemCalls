...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	27e58593          	addi	a1,a1,638 # 1290 <malloc+0x104>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	24c58593          	addi	a1,a1,588 # 12a0 <malloc+0x114>
      5c:	4509                	li	a0,2
      5e:	050010ef          	jal	10ae <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	22650513          	addi	a0,a0,550 # 12a8 <malloc+0x11c>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	2fe70713          	addi	a4,a4,766 # 13a8 <malloc+0x21c>
    ...
    panic("runcmd");
      ...
      c6:	1ee50513          	addi	a0,a0,494 # 12b0 <malloc+0x124>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	1dc58593          	addi	a1,a1,476 # 12b8 <malloc+0x12c>
      e4:	4509                	li	a0,2
      e6:	7c9000ef          	jal	10ae <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	1b858593          	addi	a1,a1,440 # 12c8 <malloc+0x13c>
     118:	4509                	li	a0,2
     11a:	795000ef          	jal	10ae <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	16650513          	addi	a0,a0,358 # 12d8 <malloc+0x14c>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	e34a8a93          	addi	s5,s5,-460 # 1300 <malloc+0x174>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	e0250513          	addi	a0,a0,-510 # 12e0 <malloc+0x154>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d6e60613          	addi	a2,a2,-658 # 1308 <malloc+0x17c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d5eb0b13          	addi	s6,s6,-674 # 1328 <malloc+0x19c>
  ...
  return ret;
     ...
     5f8:	d1c50513          	addi	a0,a0,-740 # 1310 <malloc+0x184>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	cd250513          	addi	a0,a0,-814 # 1318 <malloc+0x18c>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	cac60613          	addi	a2,a2,-852 # 1330 <malloc+0x1a4>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c58a0a13          	addi	s4,s4,-936 # 1338 <malloc+0x1ac>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	c3660613          	addi	a2,a2,-970 # 1340 <malloc+0x1b4>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	ba860613          	addi	a2,a2,-1112 # 1308 <malloc+0x17c>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	bd460613          	addi	a2,a2,-1068 # 1358 <malloc+0x1cc>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b8e50513          	addi	a0,a0,-1138 # 1348 <malloc+0x1bc>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b9a50513          	addi	a0,a0,-1126 # 1360 <malloc+0x1d4>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	bd270713          	addi	a4,a4,-1070 # 13c0 <malloc+0x234>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	a1e60613          	addi	a2,a2,-1506 # 1298 <malloc+0x10c>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	ad058593          	addi	a1,a1,-1328 # 1378 <malloc+0x1ec>
     8b0:	4509                	li	a0,2
     8b2:	7fc000ef          	jal	10ae <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a5a50513          	addi	a0,a0,-1446 # 1310 <malloc+0x184>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	ab248493          	addi	s1,s1,-1358 # 1388 <malloc+0x1fc>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	a1658593          	addi	a1,a1,-1514 # 1390 <malloc+0x204>
     982:	4509                	li	a0,2
     984:	72a000ef          	jal	10ae <fprintf>
...
0000000000000cee <mutex_acquire>:
...
0000000000000cf6 <mutex_release>:
...
0000000000000d28 <thread_create>:
...
0000000000000d3c <thread_exit>:
.global thread_exit
thread_exit:
 li a7, SYS_thread_exit
     d3c:	02300893          	li	a7,35
 ecall
     d40:	00000073          	ecall
 ret
     d44:	8082                	ret

0000000000000d46 <thread_id>:
.global thread_id
thread_id:
 li a7, SYS_thread_id
     d46:	02400893          	li	a7,36
 ecall
     d4a:	00000073          	ecall
 ret
     d4e:	8082                	ret

0000000000000d50 <putc>:
...
putc(int fd, char c)
{
     ...
     d58:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     d5c:	4605                	li	a2,1
     d5e:	fef40593          	addi	a1,s0,-17
     d62:	ef5ff0ef          	jal	c56 <write>
}
...
0000000000000d6e <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
     d6e:	715d                	addi	sp,sp,-80
     d70:	e486                	sd	ra,72(sp)
     d72:	e0a2                	sd	s0,64(sp)
     d74:	f84a                	sd	s2,48(sp)
     d76:	0880                	addi	s0,sp,80
     d78:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
     d7a:	c299                	beqz	a3,d80 <printint+0x12>
     d7c:	0805c363          	bltz	a1,e02 <printint+0x94>
  neg = 0;
     d80:	4881                	li	a7,0
     d82:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d8c:	65050513          	addi	a0,a0,1616 # 13d8 <digits>
     d90:	883e                	mv	a6,a5
     d92:	2785                	addiw	a5,a5,1
     d94:	02c5f733          	remu	a4,a1,a2
     d98:	972a                	add	a4,a4,a0
     d9a:	00074703          	lbu	a4,0(a4)
     d9e:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     da2:	872e                	mv	a4,a1
     da4:	02c5d5b3          	divu	a1,a1,a2
     da8:	0685                	addi	a3,a3,1
     daa:	fec773e3          	bgeu	a4,a2,d90 <printint+0x22>
  if(neg)
     dae:	00088b63          	beqz	a7,dc4 <printint+0x56>
    buf[i++] = '-';
     db2:	fd078793          	addi	a5,a5,-48
     db6:	97a2                	add	a5,a5,s0
     db8:	02d00713          	li	a4,45
     dbc:	fee78423          	sb	a4,-24(a5)
     dc0:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     dc4:	02f05a63          	blez	a5,df8 <printint+0x8a>
     dc8:	fc26                	sd	s1,56(sp)
     dca:	f44e                	sd	s3,40(sp)
     dcc:	fb840713          	addi	a4,s0,-72
     dd0:	00f704b3          	add	s1,a4,a5
     dd4:	fff70993          	addi	s3,a4,-1
     dd8:	99be                	add	s3,s3,a5
     dda:	37fd                	addiw	a5,a5,-1
     ddc:	1782                	slli	a5,a5,0x20
     dde:	9381                	srli	a5,a5,0x20
     de0:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     de4:	fff4c583          	lbu	a1,-1(s1)
     de8:	854a                	mv	a0,s2
     dea:	f67ff0ef          	jal	d50 <putc>
  while(--i >= 0)
     dee:	14fd                	addi	s1,s1,-1
     df0:	ff349ae3          	bne	s1,s3,de4 <printint+0x76>
     df4:	74e2                	ld	s1,56(sp)
     df6:	79a2                	ld	s3,40(sp)
}
     df8:	60a6                	ld	ra,72(sp)
     dfa:	6406                	ld	s0,64(sp)
     dfc:	7942                	ld	s2,48(sp)
     dfe:	6161                	addi	sp,sp,80
     e00:	8082                	ret
    x = -xx;
     e02:	40b005b3          	neg	a1,a1
    neg = 1;
     e06:	4885                	li	a7,1
    x = -xx;
     e08:	bfad                	j	d82 <printint+0x14>

0000000000000e0a <vprintf>:
}
...
{
     e0a:	711d                	addi	sp,sp,-96
     e0c:	ec86                	sd	ra,88(sp)
     e0e:	e8a2                	sd	s0,80(sp)
     e10:	e0ca                	sd	s2,64(sp)
     e12:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
     e14:	0005c903          	lbu	s2,0(a1)
     e18:	28090663          	beqz	s2,10a4 <vprintf+0x29a>
     e1c:	e4a6                	sd	s1,72(sp)
     e1e:	fc4e                	sd	s3,56(sp)
     e20:	f852                	sd	s4,48(sp)
     e22:	f456                	sd	s5,40(sp)
     e24:	f05a                	sd	s6,32(sp)
     e26:	ec5e                	sd	s7,24(sp)
     e28:	e862                	sd	s8,16(sp)
     e2a:	e466                	sd	s9,8(sp)
     e2c:	8b2a                	mv	s6,a0
     e2e:	8a2e                	mv	s4,a1
     e30:	8bb2                	mv	s7,a2
  ...
  for(i = 0; fmt[i]; i++){
     ...
     e38:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
     e3c:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
     e40:	06c00c93          	li	s9,108
     e44:	a005                	j	e64 <vprintf+0x5a>
        putc(fd, c0);
     e46:	85ca                	mv	a1,s2
     e48:	855a                	mv	a0,s6
     e4a:	f07ff0ef          	jal	d50 <putc>
     e4e:	a019                	j	e54 <vprintf+0x4a>
    } else if(state == '%'){
     e50:	03598263          	beq	s3,s5,e74 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     e54:	2485                	addiw	s1,s1,1
     e56:	8726                	mv	a4,s1
     e58:	009a07b3          	add	a5,s4,s1
     e5c:	0007c903          	lbu	s2,0(a5)
     e60:	22090a63          	beqz	s2,1094 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
     e64:	0009079b          	sext.w	a5,s2
    if(state == 0){
     e68:	fe0994e3          	bnez	s3,e50 <vprintf+0x46>
      if(c0 == '%'){
     e6c:	fd579de3          	bne	a5,s5,e46 <vprintf+0x3c>
        state = '%';
     e70:	89be                	mv	s3,a5
     e72:	b7cd                	j	e54 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     e74:	00ea06b3          	add	a3,s4,a4
     e78:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     e7c:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e7e:	c681                	beqz	a3,e86 <vprintf+0x7c>
     e80:	9752                	add	a4,a4,s4
     e82:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e86:	05878363          	beq	a5,s8,ecc <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     e8a:	05978d63          	beq	a5,s9,ee4 <vprintf+0xda>
     ...
     e8e:	07500713          	li	a4,117
     e92:	0ee78763          	beq	a5,a4,f80 <vprintf+0x176>
     ...
     e96:	07800713          	li	a4,120
     e9a:	12e78963          	beq	a5,a4,fcc <vprintf+0x1c2>
     ...
     e9e:	07000713          	li	a4,112
     ea2:	14e78e63          	beq	a5,a4,ffe <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     ea6:	06300713          	li	a4,99
     eaa:	18e78e63          	beq	a5,a4,1046 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     eae:	07300713          	li	a4,115
     eb2:	1ae78463          	beq	a5,a4,105a <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     eb6:	02500713          	li	a4,37
     eba:	04e79563          	bne	a5,a4,f04 <vprintf+0xfa>
        putc(fd, '%');
     ebe:	02500593          	li	a1,37
     ec2:	855a                	mv	a0,s6
     ec4:	e8dff0ef          	jal	d50 <putc>
     ...
     ed8:	855a                	mv	a0,s6
     eda:	e95ff0ef          	jal	d6e <printint>
     ede:	8bca                	mv	s7,s2
      state = 0;
     ee0:	4981                	li	s3,0
     ee2:	bf8d                	j	e54 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     ee4:	06400793          	li	a5,100
     ee8:	02f68963          	beq	a3,a5,f1a <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eec:	06c00793          	li	a5,108
     ef0:	04f68263          	beq	a3,a5,f34 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     ef4:	07500793          	li	a5,117
     ef8:	0af68063          	beq	a3,a5,f98 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     efc:	07800793          	li	a5,120
     f00:	0ef68263          	beq	a3,a5,fe4 <vprintf+0x1da>
        putc(fd, '%');
     f04:	02500593          	li	a1,37
     f08:	855a                	mv	a0,s6
     f0a:	e47ff0ef          	jal	d50 <putc>
        putc(fd, c0);
     f0e:	85ca                	mv	a1,s2
     f10:	855a                	mv	a0,s6
     f12:	e3fff0ef          	jal	d50 <putc>
      state = 0;
     f16:	4981                	li	s3,0
     f18:	bf35                	j	e54 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     f26:	855a                	mv	a0,s6
     f28:	e47ff0ef          	jal	d6e <printint>
        i += 1;
     f2c:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
     f2e:	8bca                	mv	s7,s2
      state = 0;
     f30:	4981                	li	s3,0
        i += 1;
     f32:	b70d                	j	e54 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     f34:	06400793          	li	a5,100
     f38:	02f60763          	beq	a2,a5,f66 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     f3c:	07500793          	li	a5,117
     f40:	06f60963          	beq	a2,a5,fb2 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     f44:	07800793          	li	a5,120
     f48:	faf61ee3          	bne	a2,a5,f04 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f8c:	855a                	mv	a0,s6
     f8e:	de1ff0ef          	jal	d6e <printint>
     f92:	8bca                	mv	s7,s2
      state = 0;
     f94:	4981                	li	s3,0
     f96:	bd7d                	j	e54 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     fbe:	855a                	mv	a0,s6
     fc0:	dafff0ef          	jal	d6e <printint>
        i += 2;
     fc4:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
     fc6:	8bca                	mv	s7,s2
      state = 0;
     fc8:	4981                	li	s3,0
        i += 2;
     fca:	b569                	j	e54 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
     fcc:	008b8913          	addi	s2,s7,8
     fd0:	4681                	li	a3,0
     fd2:	4641                	li	a2,16
     fd4:	000be583          	lwu	a1,0(s7)
     fd8:	855a                	mv	a0,s6
     fda:	d95ff0ef          	jal	d6e <printint>
     fde:	8bca                	mv	s7,s2
      state = 0;
     fe0:	4981                	li	s3,0
     fe2:	bd8d                	j	e54 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     ffa:	4981                	li	s3,0
        i += 1;
     ffc:	bda1                	j	e54 <vprintf+0x4a>
     ffe:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    1000:	008b8d13          	addi	s10,s7,8
    1004:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    1008:	03000593          	li	a1,48
    100c:	855a                	mv	a0,s6
    100e:	d43ff0ef          	jal	d50 <putc>
  putc(fd, 'x');
    1012:	07800593          	li	a1,120
    1016:	855a                	mv	a0,s6
    1018:	d39ff0ef          	jal	d50 <putc>
    101c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    101e:	00000b97          	auipc	s7,0x0
    1022:	3bab8b93          	addi	s7,s7,954 # 13d8 <digits>
    1026:	03c9d793          	srli	a5,s3,0x3c
    102a:	97de                	add	a5,a5,s7
    102c:	0007c583          	lbu	a1,0(a5)
    1030:	855a                	mv	a0,s6
    1032:	d1fff0ef          	jal	d50 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1036:	0992                	slli	s3,s3,0x4
    1038:	397d                	addiw	s2,s2,-1
    103a:	fe0916e3          	bnez	s2,1026 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    103e:	8bea                	mv	s7,s10
      state = 0;
    1040:	4981                	li	s3,0
    1042:	6d02                	ld	s10,0(sp)
    1044:	bd01                	j	e54 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    1046:	008b8913          	addi	s2,s7,8
    104a:	000bc583          	lbu	a1,0(s7)
    104e:	855a                	mv	a0,s6
    1050:	d01ff0ef          	jal	d50 <putc>
    1054:	8bca                	mv	s7,s2
      state = 0;
    1056:	4981                	li	s3,0
    1058:	bbf5                	j	e54 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    105a:	008b8993          	addi	s3,s7,8
    105e:	000bb903          	ld	s2,0(s7)
    1062:	00090f63          	beqz	s2,1080 <vprintf+0x276>
        for(; *s; s++)
    1066:	00094583          	lbu	a1,0(s2)
    106a:	c195                	beqz	a1,108e <vprintf+0x284>
          putc(fd, *s);
    106c:	855a                	mv	a0,s6
    106e:	ce3ff0ef          	jal	d50 <putc>
        for(; *s; s++)
    1072:	0905                	addi	s2,s2,1
    1074:	00094583          	lbu	a1,0(s2)
    1078:	f9f5                	bnez	a1,106c <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    107a:	8bce                	mv	s7,s3
      state = 0;
    107c:	4981                	li	s3,0
    107e:	bbd9                	j	e54 <vprintf+0x4a>
          s = "(null)";
    1080:	00000917          	auipc	s2,0x0
    1084:	32090913          	addi	s2,s2,800 # 13a0 <malloc+0x214>
        for(; *s; s++)
    1088:	02800593          	li	a1,40
    108c:	b7c5                	j	106c <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    108e:	8bce                	mv	s7,s3
      state = 0;
    1090:	4981                	li	s3,0
    1092:	b3c9                	j	e54 <vprintf+0x4a>
    1094:	64a6                	ld	s1,72(sp)
    1096:	79e2                	ld	s3,56(sp)
    1098:	7a42                	ld	s4,48(sp)
    109a:	7aa2                	ld	s5,40(sp)
    109c:	7b02                	ld	s6,32(sp)
    109e:	6be2                	ld	s7,24(sp)
    10a0:	6c42                	ld	s8,16(sp)
    10a2:	6ca2                	ld	s9,8(sp)
    }
  }
}
    10a4:	60e6                	ld	ra,88(sp)
    10a6:	6446                	ld	s0,80(sp)
    10a8:	6906                	ld	s2,64(sp)
    10aa:	6125                	addi	sp,sp,96
    10ac:	8082                	ret

00000000000010ae <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    10ae:	715d                	addi	sp,sp,-80
    10b0:	ec06                	sd	ra,24(sp)
    10b2:	e822                	sd	s0,16(sp)
    10b4:	1000                	addi	s0,sp,32
    10b6:	e010                	sd	a2,0(s0)
    10b8:	e414                	sd	a3,8(s0)
    10ba:	e818                	sd	a4,16(s0)
    10bc:	ec1c                	sd	a5,24(s0)
    10be:	03043023          	sd	a6,32(s0)
    10c2:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    10c6:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    10ca:	8622                	mv	a2,s0
    10cc:	d3fff0ef          	jal	e0a <vprintf>
}
    10d0:	60e2                	ld	ra,24(sp)
    10d2:	6442                	ld	s0,16(sp)
    10d4:	6161                	addi	sp,sp,80
    10d6:	8082                	ret
...
printf(const char *fmt, ...)
{
    ...
    10e0:	e40c                	sd	a1,8(s0)
    10e2:	e810                	sd	a2,16(s0)
    10e4:	ec14                	sd	a3,24(s0)
    10e6:	f018                	sd	a4,32(s0)
    10e8:	f41c                	sd	a5,40(s0)
    10ea:	03043823          	sd	a6,48(s0)
    10ee:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    10f2:	00840613          	addi	a2,s0,8
    10f6:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    10fa:	85aa                	mv	a1,a0
    10fc:	4505                	li	a0,1
    10fe:	d0dff0ef          	jal	e0a <vprintf>
}
    1102:	60e2                	ld	ra,24(sp)
    1104:	6442                	ld	s0,16(sp)
    1106:	6125                	addi	sp,sp,96
    1108:	8082                	ret

000000000000110a <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    110c:	e422                	sd	s0,8(sp)
    110e:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1110:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1114:	00001797          	auipc	a5,0x1
    1118:	efc7b783          	ld	a5,-260(a5) # 2010 <freep>
    111c:	a02d                	j	1146 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    111e:	4618                	lw	a4,8(a2)
    1120:	9f2d                	addw	a4,a4,a1
    1122:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1126:	6398                	ld	a4,0(a5)
    1128:	6310                	ld	a2,0(a4)
    112a:	a83d                	j	1168 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    112c:	ff852703          	lw	a4,-8(a0)
    1130:	9f31                	addw	a4,a4,a2
    1132:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1134:	ff053683          	ld	a3,-16(a0)
    1138:	a091                	j	117c <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    113a:	6398                	ld	a4,0(a5)
    113c:	00e7e463          	bltu	a5,a4,1144 <free+0x3a>
    1140:	00e6ea63          	bltu	a3,a4,1154 <free+0x4a>
{
    1144:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1146:	fed7fae3          	bgeu	a5,a3,113a <free+0x30>
    114a:	6398                	ld	a4,0(a5)
    114c:	00e6e463          	bltu	a3,a4,1154 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1150:	fee7eae3          	bltu	a5,a4,1144 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1154:	ff852583          	lw	a1,-8(a0)
    1158:	6390                	ld	a2,0(a5)
    115a:	02059813          	slli	a6,a1,0x20
    115e:	01c85713          	srli	a4,a6,0x1c
    1162:	9736                	add	a4,a4,a3
    1164:	fae60de3          	beq	a2,a4,111e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    1168:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    116c:	4790                	lw	a2,8(a5)
    116e:	02061593          	slli	a1,a2,0x20
    1172:	01c5d713          	srli	a4,a1,0x1c
    1176:	973e                	add	a4,a4,a5
    1178:	fae68ae3          	beq	a3,a4,112c <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11a8:	00001517          	auipc	a0,0x1
    11ac:	e6853503          	ld	a0,-408(a0) # 2010 <freep>
    11b0:	c915                	beqz	a0,11e4 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11b6:	08977a63          	bgeu	a4,s1,124a <malloc+0xbe>
    11ba:	f04a                	sd	s2,32(sp)
    11bc:	e852                	sd	s4,16(sp)
    11be:	e456                	sd	s5,8(sp)
    11c0:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    11c2:	8a4e                	mv	s4,s3
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    11d8:	00001917          	auipc	s2,0x1
    11dc:	e3890913          	addi	s2,s2,-456 # 2010 <freep>
  if(p == SBRK_ERROR)
    11e0:	5afd                	li	s5,-1
    11e2:	a081                	j	1222 <malloc+0x96>
    11e4:	f04a                	sd	s2,32(sp)
    11e6:	e852                	sd	s4,16(sp)
    11e8:	e456                	sd	s5,8(sp)
    11ea:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    11ec:	00001797          	auipc	a5,0x1
    11f0:	e9c78793          	addi	a5,a5,-356 # 2088 <base>
    11f4:	00001717          	auipc	a4,0x1
    11f8:	e0f73e23          	sd	a5,-484(a4) # 2010 <freep>
    11fc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    11fe:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1202:	b7c1                	j	11c2 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    1204:	6398                	ld	a4,0(a5)
    1206:	e118                	sd	a4,0(a0)
    1208:	a8a9                	j	1262 <malloc+0xd6>
  hp->s.size = nu;
    120a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    120e:	0541                	addi	a0,a0,16
    1210:	efbff0ef          	jal	110a <free>
  return freep;
    1214:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1218:	c12d                	beqz	a0,127a <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    121a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    121c:	4798                	lw	a4,8(a5)
    121e:	02977263          	bgeu	a4,s1,1242 <malloc+0xb6>
    if(p == freep)
    1222:	00093703          	ld	a4,0(s2)
    1226:	853e                	mv	a0,a5
    1228:	fef719e3          	bne	a4,a5,121a <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    122c:	8552                	mv	a0,s4
    122e:	9cdff0ef          	jal	bfa <sbrk>
  if(p == SBRK_ERROR)
    1232:	fd551ce3          	bne	a0,s5,120a <malloc+0x7e>
        return 0;
    1236:	4501                	li	a0,0
    1238:	7902                	ld	s2,32(sp)
    123a:	6a42                	ld	s4,16(sp)
    123c:	6aa2                	ld	s5,8(sp)
    123e:	6b02                	ld	s6,0(sp)
    1240:	a03d                	j	126e <malloc+0xe2>
    1242:	7902                	ld	s2,32(sp)
    1244:	6a42                	ld	s4,16(sp)
    1246:	6aa2                	ld	s5,8(sp)
    1248:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    124a:	fae48de3          	beq	s1,a4,1204 <malloc+0x78>
        p->s.size -= nunits;
    124e:	4137073b          	subw	a4,a4,s3
    1252:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1254:	02071693          	slli	a3,a4,0x20
    1258:	01c6d713          	srli	a4,a3,0x1c
    125c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    125e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1262:	00001717          	auipc	a4,0x1
    1266:	daa73723          	sd	a0,-594(a4) # 2010 <freep>
      return (void*)(p + 1);
    126a:	01078513          	addi	a0,a5,16
  }
}
    126e:	70e2                	ld	ra,56(sp)
    1270:	7442                	ld	s0,48(sp)
    1272:	74a2                	ld	s1,40(sp)
    1274:	69e2                	ld	s3,24(sp)
    1276:	6121                	addi	sp,sp,64
    1278:	8082                	ret
    127a:	7902                	ld	s2,32(sp)
    127c:	6a42                	ld	s4,16(sp)
    127e:	6aa2                	ld	s5,8(sp)
    1280:	6b02                	ld	s6,0(sp)
    1282:	b7f5                	j	126e <malloc+0xe2>
