...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	94278793          	addi	a5,a5,-1726 # 7950 <malloc+0x267e>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	36a50513          	addi	a0,a0,874 # 53d0 <malloc+0xfe>
      6e:	1b0050ef          	jal	521e <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	35050513          	addi	a0,a0,848 # 53f0 <malloc+0x11e>
      a8:	176050ef          	jal	521e <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	34850513          	addi	a0,a0,840 # 5408 <malloc+0x136>
      c8:	4f5040ef          	jal	4dbc <open>
  if(fd < 0){
      cc:	02054263          	bltz	a0,f0 <opentest+0x3e>
  close(fd);
      d0:	4d5040ef          	jal	4da4 <close>
  fd = open("doesnotexist", 0);
      d4:	4581                	li	a1,0
      d6:	00005517          	auipc	a0,0x5
      da:	35250513          	addi	a0,a0,850 # 5428 <malloc+0x156>
      de:	4df040ef          	jal	4dbc <open>
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	31e50513          	addi	a0,a0,798 # 5410 <malloc+0x13e>
      fa:	124050ef          	jal	521e <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	33250513          	addi	a0,a0,818 # 5438 <malloc+0x166>
     10e:	110050ef          	jal	521e <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     12c:	33850513          	addi	a0,a0,824 # 5460 <malloc+0x18e>
     130:	49d040ef          	jal	4dcc <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     134:	60100593          	li	a1,1537
     138:	00005517          	auipc	a0,0x5
     13c:	32850513          	addi	a0,a0,808 # 5460 <malloc+0x18e>
     140:	47d040ef          	jal	4dbc <open>
     144:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     146:	4611                	li	a2,4
     148:	00005597          	auipc	a1,0x5
     14c:	32858593          	addi	a1,a1,808 # 5470 <malloc+0x19e>
     150:	44d040ef          	jal	4d9c <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     154:	40100593          	li	a1,1025
     158:	00005517          	auipc	a0,0x5
     15c:	30850513          	addi	a0,a0,776 # 5460 <malloc+0x18e>
     160:	45d040ef          	jal	4dbc <open>
     164:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     166:	4605                	li	a2,1
     168:	00005597          	auipc	a1,0x5
     16c:	31058593          	addi	a1,a1,784 # 5478 <malloc+0x1a6>
     170:	8526                	mv	a0,s1
     172:	42b040ef          	jal	4d9c <write>
  if(n != -1){
     176:	57fd                	li	a5,-1
     178:	02f51563          	bne	a0,a5,1a2 <truncate2+0x8a>
  unlink("truncfile");
     17c:	00005517          	auipc	a0,0x5
     180:	2e450513          	addi	a0,a0,740 # 5460 <malloc+0x18e>
     184:	449040ef          	jal	4dcc <unlink>
  close(fd1);
     188:	8526                	mv	a0,s1
     18a:	41b040ef          	jal	4da4 <close>
  close(fd2);
     18e:	854a                	mv	a0,s2
     190:	415040ef          	jal	4da4 <close>
}
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	2da50513          	addi	a0,a0,730 # 5480 <malloc+0x1ae>
     1ae:	070050ef          	jal	521e <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
00000000000001b8 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     1e4:	3d9040ef          	jal	4dbc <open>
    close(fd);
     1e8:	3bd040ef          	jal	4da4 <close>
  for(i = 0; i < N; i++){
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	26450513          	addi	a0,a0,612 # 54a8 <malloc+0x1d6>
     24c:	381040ef          	jal	4dcc <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	254a8a93          	addi	s5,s5,596 # 54a8 <malloc+0x1d6>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    if(fd < 0){
     ...
     28a:	85d2                	mv	a1,s4
     28c:	854a                	mv	a0,s2
     28e:	30f040ef          	jal	4d9c <write>
      if(cc != sz){
     292:	04951263          	bne	a0,s1,2d6 <bigwrite+0xaa>
    close(fd);
     296:	854a                	mv	a0,s2
     298:	30d040ef          	jal	4da4 <close>
    unlink("bigwrite");
     29c:	8556                	mv	a0,s5
     29e:	32f040ef          	jal	4dcc <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	1f650513          	addi	a0,a0,502 # 54b8 <malloc+0x1e6>
     2ca:	755040ef          	jal	521e <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	1fc50513          	addi	a0,a0,508 # 54d8 <malloc+0x206>
     2e4:	73b040ef          	jal	521e <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	1f250513          	addi	a0,a0,498 # 54f0 <malloc+0x21e>
     306:	2c7040ef          	jal	4dcc <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	1e298993          	addi	s3,s3,482 # 54f0 <malloc+0x21e>
    if(fd < 0){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     32c:	4605                	li	a2,1
     32e:	85d2                	mv	a1,s4
     330:	26d040ef          	jal	4d9c <write>
    close(fd);
     334:	8526                	mv	a0,s1
     336:	26f040ef          	jal	4da4 <close>
    unlink("junk");
     33a:	854e                	mv	a0,s3
     33c:	291040ef          	jal	4dcc <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	1a650513          	addi	a0,a0,422 # 54f0 <malloc+0x21e>
     352:	26b040ef          	jal	4dbc <open>
     356:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	11a58593          	addi	a1,a1,282 # 5478 <malloc+0x1a6>
     366:	237040ef          	jal	4d9c <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	1a050513          	addi	a0,a0,416 # 5510 <malloc+0x23e>
     378:	6a7040ef          	jal	521e <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	1f7040ef          	jal	4d74 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	17650513          	addi	a0,a0,374 # 54f8 <malloc+0x226>
     38a:	695040ef          	jal	521e <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	1e5040ef          	jal	4d74 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	16450513          	addi	a0,a0,356 # 54f8 <malloc+0x226>
     39c:	683040ef          	jal	521e <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  close(fd);
     3a6:	8526                	mv	a0,s1
     3a8:	1fd040ef          	jal	4da4 <close>
  unlink("junk");
     3ac:	00005517          	auipc	a0,0x5
     3b0:	14450513          	addi	a0,a0,324 # 54f0 <malloc+0x21e>
     3b4:	219040ef          	jal	4dcc <unlink>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	4c078793          	addi	a5,a5,1216 # 7950 <malloc+0x267e>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	062a0a13          	addi	s4,s4,98 # 5520 <malloc+0x24e>
    uint64 addr = addrs[ai];
     4c6:	00093983          	ld	s3,0(s2)
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     4ca:	20100593          	li	a1,513
     4ce:	8552                	mv	a0,s4
     4d0:	0ed040ef          	jal	4dbc <open>
     4d4:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	fe450513          	addi	a0,a0,-28 # 5528 <malloc+0x256>
     54c:	4d3040ef          	jal	521e <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	fe650513          	addi	a0,a0,-26 # 5540 <malloc+0x26e>
     562:	4bd040ef          	jal	521e <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	00050513          	mv	a0,a0
     578:	4a7040ef          	jal	521e <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	7f6040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	01e50513          	addi	a0,a0,30 # 55a0 <malloc+0x2ce>
     58a:	495040ef          	jal	521e <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	01850513          	addi	a0,a0,24 # 55b0 <malloc+0x2de>
     5a0:	47f040ef          	jal	521e <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	39278793          	addi	a5,a5,914 # 7950 <malloc+0x267e>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	feea0a13          	addi	s4,s4,-18 # 55e0 <malloc+0x30e>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	e7ea8a93          	addi	s5,s5,-386 # 5478 <malloc+0x1a6>
    uint64 addr = addrs[ai];
     602:	00093983          	ld	s3,0(s2)
    int fd = open("README", 0);
     606:	4581                	li	a1,0
     608:	8552                	mv	a0,s4
     60a:	7b2040ef          	jal	4dbc <open>
     60e:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	f6a50513          	addi	a0,a0,-150 # 55e8 <malloc+0x316>
     686:	399040ef          	jal	521e <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	f6c50513          	addi	a0,a0,-148 # 5600 <malloc+0x32e>
     69c:	383040ef          	jal	521e <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	6d2040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	efa50513          	addi	a0,a0,-262 # 55a0 <malloc+0x2ce>
     6ae:	371040ef          	jal	521e <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	6c0040ef          	jal	4d74 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	f7850513          	addi	a0,a0,-136 # 5630 <malloc+0x35e>
     6c0:	35f040ef          	jal	521e <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	f7a50513          	addi	a0,a0,-134 # 5648 <malloc+0x376>
     6d6:	349040ef          	jal	521e <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	d6c50513          	addi	a0,a0,-660 # 5460 <malloc+0x18e>
     6fc:	6d0040ef          	jal	4dcc <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	d5c50513          	addi	a0,a0,-676 # 5460 <malloc+0x18e>
     70c:	6b0040ef          	jal	4dbc <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	d5c58593          	addi	a1,a1,-676 # 5470 <malloc+0x19e>
     71c:	680040ef          	jal	4d9c <write>
  close(fd1);
     720:	8526                	mv	a0,s1
     722:	682040ef          	jal	4da4 <close>
  int fd2 = open("truncfile", O_RDONLY);
     726:	4581                	li	a1,0
     728:	00005517          	auipc	a0,0x5
     72c:	d3850513          	addi	a0,a0,-712 # 5460 <malloc+0x18e>
     730:	68c040ef          	jal	4dbc <open>
     734:	84aa                	mv	s1,a0
  int n = read(fd2, buf, sizeof(buf));
     736:	02000613          	li	a2,32
     73a:	fa040593          	addi	a1,s0,-96
     73e:	656040ef          	jal	4d94 <read>
  if(n != 4){
     742:	4791                	li	a5,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	d1450513          	addi	a0,a0,-748 # 5460 <malloc+0x18e>
     754:	668040ef          	jal	4dbc <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	d0450513          	addi	a0,a0,-764 # 5460 <malloc+0x18e>
     764:	658040ef          	jal	4dbc <open>
     768:	892a                	mv	s2,a0
  n = read(fd3, buf, sizeof(buf));
     76a:	02000613          	li	a2,32
     76e:	fa040593          	addi	a1,s0,-96
     772:	622040ef          	jal	4d94 <read>
     776:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	f4a58593          	addi	a1,a1,-182 # 56d8 <malloc+0x406>
     796:	854e                	mv	a0,s3
     798:	604040ef          	jal	4d9c <write>
  n = read(fd3, buf, sizeof(buf));
     79c:	02000613          	li	a2,32
     7a0:	fa040593          	addi	a1,s0,-96
     7a4:	854a                	mv	a0,s2
     7a6:	5ee040ef          	jal	4d94 <read>
  if(n != 6){
     7aa:	4799                	li	a5,6
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     7b8:	8526                	mv	a0,s1
     7ba:	5da040ef          	jal	4d94 <read>
  if(n != 2){
     7be:	4789                	li	a5,2
     7c0:	0af51463          	bne	a0,a5,868 <truncate1+0x188>
  unlink("truncfile");
     7c4:	00005517          	auipc	a0,0x5
     7c8:	c9c50513          	addi	a0,a0,-868 # 5460 <malloc+0x18e>
     7cc:	600040ef          	jal	4dcc <unlink>
  close(fd1);
     7d0:	854e                	mv	a0,s3
     7d2:	5d2040ef          	jal	4da4 <close>
  close(fd2);
     7d6:	8526                	mv	a0,s1
     7d8:	5cc040ef          	jal	4da4 <close>
  close(fd3);
     7dc:	854a                	mv	a0,s2
     7de:	5c6040ef          	jal	4da4 <close>
}
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e8050513          	addi	a0,a0,-384 # 5678 <malloc+0x3a6>
     800:	21f040ef          	jal	521e <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	e8c50513          	addi	a0,a0,-372 # 5698 <malloc+0x3c6>
     814:	20b040ef          	jal	521e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e8c50513          	addi	a0,a0,-372 # 56a8 <malloc+0x3d6>
     824:	1fb040ef          	jal	521e <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	e9850513          	addi	a0,a0,-360 # 56c8 <malloc+0x3f6>
     838:	1e7040ef          	jal	521e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	e6850513          	addi	a0,a0,-408 # 56a8 <malloc+0x3d6>
     848:	1d7040ef          	jal	521e <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	e8a50513          	addi	a0,a0,-374 # 56e0 <malloc+0x40e>
     85e:	1c1040ef          	jal	521e <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	e9450513          	addi	a0,a0,-364 # 5700 <malloc+0x42e>
     874:	1ab040ef          	jal	521e <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e8850513          	addi	a0,a0,-376 # 5720 <malloc+0x44e>
     8a0:	51c040ef          	jal	4dbc <open>
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e9c98993          	addi	s3,s3,-356 # 5748 <malloc+0x476>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	ecca8a93          	addi	s5,s5,-308 # 5780 <malloc+0x4ae>
  for(i = 0; i < N; i++){
  ...
  close(fd);
     8e6:	854a                	mv	a0,s2
     8e8:	4bc040ef          	jal	4da4 <close>
  fd = open("small", O_RDONLY);
     8ec:	4581                	li	a1,0
     8ee:	00005517          	auipc	a0,0x5
     8f2:	e3250513          	addi	a0,a0,-462 # 5720 <malloc+0x44e>
     8f6:	4c6040ef          	jal	4dbc <open>
     8fa:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     90c:	488040ef          	jal	4d94 <read>
  if(i != N*SZ*2){
     910:	7d000793          	li	a5,2000
     914:	08f51163          	bne	a0,a5,996 <writetest+0x118>
  close(fd);
     918:	8526                	mv	a0,s1
     91a:	48a040ef          	jal	4da4 <close>
  if(unlink("small") < 0){
     91e:	00005517          	auipc	a0,0x5
     922:	e0250513          	addi	a0,a0,-510 # 5720 <malloc+0x44e>
     926:	4a6040ef          	jal	4dcc <unlink>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	de450513          	addi	a0,a0,-540 # 5728 <malloc+0x456>
     94c:	0d3040ef          	jal	521e <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	dfe50513          	addi	a0,a0,-514 # 5758 <malloc+0x486>
     962:	0bd040ef          	jal	521e <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	e2050513          	addi	a0,a0,-480 # 5790 <malloc+0x4be>
     978:	0a7040ef          	jal	521e <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	e3450513          	addi	a0,a0,-460 # 57b8 <malloc+0x4e6>
     98c:	093040ef          	jal	521e <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	e4050513          	addi	a0,a0,-448 # 57d8 <malloc+0x506>
     9a0:	07f040ef          	jal	521e <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	e4450513          	addi	a0,a0,-444 # 57f0 <malloc+0x51e>
     9b4:	06b040ef          	jal	521e <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	e3a50513          	addi	a0,a0,-454 # 5810 <malloc+0x53e>
     9de:	3de040ef          	jal	4dbc <open>
     9e2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9e4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  close(fd);
     a14:	854e                	mv	a0,s3
     a16:	38e040ef          	jal	4da4 <close>
  fd = open("big", O_RDONLY);
     a1a:	4581                	li	a1,0
     a1c:	00005517          	auipc	a0,0x5
     a20:	df450513          	addi	a0,a0,-524 # 5810 <malloc+0x53e>
     a24:	398040ef          	jal	4dbc <open>
     a28:	89aa                	mv	s3,a0
  n = 0;
     a2a:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	dbc50513          	addi	a0,a0,-580 # 5818 <malloc+0x546>
     a64:	7ba040ef          	jal	521e <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	dc650513          	addi	a0,a0,-570 # 5838 <malloc+0x566>
     a7a:	7a4040ef          	jal	521e <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	dda50513          	addi	a0,a0,-550 # 5860 <malloc+0x58e>
     a8e:	790040ef          	jal	521e <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  close(fd);
     aa0:	854e                	mv	a0,s3
     aa2:	302040ef          	jal	4da4 <close>
  if(unlink("big") < 0){
     aa6:	00005517          	auipc	a0,0x5
     aaa:	d6a50513          	addi	a0,a0,-662 # 5810 <malloc+0x53e>
     aae:	31e040ef          	jal	4dcc <unlink>
     ...
     ad0:	db450513          	addi	a0,a0,-588 # 5880 <malloc+0x5ae>
     ad4:	74a040ef          	jal	521e <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	dc650513          	addi	a0,a0,-570 # 58a8 <malloc+0x5d6>
     aea:	734040ef          	jal	521e <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	dc850513          	addi	a0,a0,-568 # 58c0 <malloc+0x5ee>
     b00:	71e040ef          	jal	521e <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	ddc50513          	addi	a0,a0,-548 # 58e8 <malloc+0x616>
     b14:	70a040ef          	jal	521e <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	dce50513          	addi	a0,a0,-562 # 5900 <malloc+0x62e>
     b3a:	282040ef          	jal	4dbc <open>
  if(fd < 0){
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	dea58593          	addi	a1,a1,-534 # 5930 <malloc+0x65e>
     b4e:	24e040ef          	jal	4d9c <write>
  close(fd);
     b52:	8526                	mv	a0,s1
     b54:	250040ef          	jal	4da4 <close>
  fd = open("unlinkread", O_RDWR);
     b58:	4589                	li	a1,2
     b5a:	00005517          	auipc	a0,0x5
     b5e:	da650513          	addi	a0,a0,-602 # 5900 <malloc+0x62e>
     b62:	25a040ef          	jal	4dbc <open>
     b66:	84aa                	mv	s1,a0
  if(fd < 0){
     b68:	0a054463          	bltz	a0,c10 <unlinkread+0xf2>
  if(unlink("unlinkread") != 0){
     b6c:	00005517          	auipc	a0,0x5
     b70:	d9450513          	addi	a0,a0,-620 # 5900 <malloc+0x62e>
     b74:	258040ef          	jal	4dcc <unlink>
     b78:	e555                	bnez	a0,c24 <unlinkread+0x106>
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     b7a:	20200593          	li	a1,514
     b7e:	00005517          	auipc	a0,0x5
     b82:	d8250513          	addi	a0,a0,-638 # 5900 <malloc+0x62e>
     b86:	236040ef          	jal	4dbc <open>
     b8a:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     b8c:	460d                	li	a2,3
     b8e:	00005597          	auipc	a1,0x5
     b92:	dea58593          	addi	a1,a1,-534 # 5978 <malloc+0x6a6>
     b96:	206040ef          	jal	4d9c <write>
  close(fd1);
     b9a:	854a                	mv	a0,s2
     b9c:	208040ef          	jal	4da4 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ba0:	660d                	lui	a2,0x3
     ba2:	0000c597          	auipc	a1,0xc
     ba6:	11658593          	addi	a1,a1,278 # ccb8 <buf>
     baa:	8526                	mv	a0,s1
     bac:	1e8040ef          	jal	4d94 <read>
     bb0:	4795                	li	a5,5
  ...
  if(write(fd, buf, 10) != 10){
     ...
     bd0:	8526                	mv	a0,s1
     bd2:	1ca040ef          	jal	4d9c <write>
     bd6:	47a9                	li	a5,10
     bd8:	08f51463          	bne	a0,a5,c60 <unlinkread+0x142>
  close(fd);
     bdc:	8526                	mv	a0,s1
     bde:	1c6040ef          	jal	4da4 <close>
  unlink("unlinkread");
     be2:	00005517          	auipc	a0,0x5
     be6:	d1e50513          	addi	a0,a0,-738 # 5900 <malloc+0x62e>
     bea:	1e2040ef          	jal	4dcc <unlink>
}
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	d1250513          	addi	a0,a0,-750 # 5910 <malloc+0x63e>
     c06:	618040ef          	jal	521e <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	d2650513          	addi	a0,a0,-730 # 5938 <malloc+0x666>
     c1a:	604040ef          	jal	521e <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	d3250513          	addi	a0,a0,-718 # 5958 <malloc+0x686>
     c2e:	5f0040ef          	jal	521e <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	d4650513          	addi	a0,a0,-698 # 5980 <malloc+0x6ae>
     c42:	5dc040ef          	jal	521e <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	d5250513          	addi	a0,a0,-686 # 59a0 <malloc+0x6ce>
     c56:	5c8040ef          	jal	521e <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	d5e50513          	addi	a0,a0,-674 # 59c0 <malloc+0x6ee>
     c6a:	5b4040ef          	jal	521e <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	d5e50513          	addi	a0,a0,-674 # 59e0 <malloc+0x70e>
     c8a:	142040ef          	jal	4dcc <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	d5a50513          	addi	a0,a0,-678 # 59e8 <malloc+0x716>
     c96:	136040ef          	jal	4dcc <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	d4250513          	addi	a0,a0,-702 # 59e0 <malloc+0x70e>
     ca6:	116040ef          	jal	4dbc <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	c7e58593          	addi	a1,a1,-898 # 5930 <malloc+0x65e>
     cba:	0e2040ef          	jal	4d9c <write>
     cbe:	4795                	li	a5,5
     cc0:	0cf51e63          	bne	a0,a5,d9c <linktest+0x128>
  close(fd);
     cc4:	8526                	mv	a0,s1
     cc6:	0de040ef          	jal	4da4 <close>
  if(link("lf1", "lf2") < 0){
     cca:	00005597          	auipc	a1,0x5
     cce:	d1e58593          	addi	a1,a1,-738 # 59e8 <malloc+0x716>
     cd2:	00005517          	auipc	a0,0x5
     cd6:	d0e50513          	addi	a0,a0,-754 # 59e0 <malloc+0x70e>
     cda:	102040ef          	jal	4ddc <link>
     cde:	0c054963          	bltz	a0,db0 <linktest+0x13c>
  unlink("lf1");
     ce2:	00005517          	auipc	a0,0x5
     ce6:	cfe50513          	addi	a0,a0,-770 # 59e0 <malloc+0x70e>
     cea:	0e2040ef          	jal	4dcc <unlink>
  if(open("lf1", 0) >= 0){
     cee:	4581                	li	a1,0
     cf0:	00005517          	auipc	a0,0x5
     cf4:	cf050513          	addi	a0,a0,-784 # 59e0 <malloc+0x70e>
     cf8:	0c4040ef          	jal	4dbc <open>
     cfc:	0c055463          	bgez	a0,dc4 <linktest+0x150>
  fd = open("lf2", 0);
     d00:	4581                	li	a1,0
     d02:	00005517          	auipc	a0,0x5
     d06:	ce650513          	addi	a0,a0,-794 # 59e8 <malloc+0x716>
     d0a:	0b2040ef          	jal	4dbc <open>
     d0e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     d1e:	076040ef          	jal	4d94 <read>
     d22:	4795                	li	a5,5
     d24:	0cf51463          	bne	a0,a5,dec <linktest+0x178>
  close(fd);
     d28:	8526                	mv	a0,s1
     d2a:	07a040ef          	jal	4da4 <close>
  if(link("lf2", "lf2") >= 0){
     d2e:	00005597          	auipc	a1,0x5
     d32:	cba58593          	addi	a1,a1,-838 # 59e8 <malloc+0x716>
     d36:	852e                	mv	a0,a1
     d38:	0a4040ef          	jal	4ddc <link>
     d3c:	0c055263          	bgez	a0,e00 <linktest+0x18c>
  unlink("lf2");
     d40:	00005517          	auipc	a0,0x5
     d44:	ca850513          	addi	a0,a0,-856 # 59e8 <malloc+0x716>
     d48:	084040ef          	jal	4dcc <unlink>
  if(link("lf2", "lf1") >= 0){
     d4c:	00005597          	auipc	a1,0x5
     d50:	c9458593          	addi	a1,a1,-876 # 59e0 <malloc+0x70e>
     d54:	00005517          	auipc	a0,0x5
     d58:	c9450513          	addi	a0,a0,-876 # 59e8 <malloc+0x716>
     d5c:	080040ef          	jal	4ddc <link>
     d60:	0a055a63          	bgez	a0,e14 <linktest+0x1a0>
  if(link(".", "lf1") >= 0){
     d64:	00005597          	auipc	a1,0x5
     d68:	c7c58593          	addi	a1,a1,-900 # 59e0 <malloc+0x70e>
     d6c:	00005517          	auipc	a0,0x5
     d70:	d8450513          	addi	a0,a0,-636 # 5af0 <malloc+0x81e>
     d74:	068040ef          	jal	4ddc <link>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	c6650513          	addi	a0,a0,-922 # 59f0 <malloc+0x71e>
     d92:	48c040ef          	jal	521e <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	c6a50513          	addi	a0,a0,-918 # 5a08 <malloc+0x736>
     da6:	478040ef          	jal	521e <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	c6e50513          	addi	a0,a0,-914 # 5a20 <malloc+0x74e>
     dba:	464040ef          	jal	521e <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	c7a50513          	addi	a0,a0,-902 # 5a40 <malloc+0x76e>
     dce:	450040ef          	jal	521e <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	c9650513          	addi	a0,a0,-874 # 5a70 <malloc+0x79e>
     de2:	43c040ef          	jal	521e <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	c9a50513          	addi	a0,a0,-870 # 5a88 <malloc+0x7b6>
     df6:	428040ef          	jal	521e <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	c9e50513          	addi	a0,a0,-866 # 5aa0 <malloc+0x7ce>
     e0a:	414040ef          	jal	521e <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	cb250513          	addi	a0,a0,-846 # 5ac8 <malloc+0x7f6>
     e1e:	400040ef          	jal	521e <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	cce50513          	addi	a0,a0,-818 # 5af8 <malloc+0x826>
     e32:	3ec040ef          	jal	521e <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	cc498993          	addi	s3,s3,-828 # 5b18 <malloc+0x846>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c9c50513          	addi	a0,a0,-868 # 5b28 <malloc+0x856>
     e94:	38a040ef          	jal	521e <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c9450513          	addi	a0,a0,-876 # 5b48 <malloc+0x876>
     ebc:	711030ef          	jal	4dcc <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c8450513          	addi	a0,a0,-892 # 5b48 <malloc+0x876>
     ecc:	6f1030ef          	jal	4dbc <open>
  if(fd < 0){
     ed0:	0c054163          	bltz	a0,f92 <bigdir+0xf4>
  close(fd);
     ed4:	6d1030ef          	jal	4da4 <close>
  for(i = 0; i < N; i++){
     ed8:	4901                	li	s2,0
    name[0] = 'x';
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	c6aa0a13          	addi	s4,s4,-918 # 5b48 <malloc+0x876>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	c1c50513          	addi	a0,a0,-996 # 5b48 <malloc+0x876>
     f34:	699030ef          	jal	4dcc <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	bbc50513          	addi	a0,a0,-1092 # 5b50 <malloc+0x87e>
     f9c:	282040ef          	jal	521e <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	bc250513          	addi	a0,a0,-1086 # 5b70 <malloc+0x89e>
     fb6:	268040ef          	jal	521e <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	bd650513          	addi	a0,a0,-1066 # 5b98 <malloc+0x8c6>
     fca:	254040ef          	jal	521e <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000000fd4 <pgbug>:
{
  ...
  exec(big, argv);
     ...
     fee:	6088                	ld	a0,0(s1)
     ff0:	5c5030ef          	jal	4db4 <exec>
  pipe(big);
     ff4:	6088                	ld	a0,0(s1)
     ff6:	597030ef          	jal	4d8c <pipe>
  exit(0);
     ffa:	4501                	li	a0,0
...
0000000000001000 <badarg>:
{
    ...
    101e:	3ee98993          	addi	s3,s3,1006 # 5408 <malloc+0x136>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    10e8:	86c78793          	addi	a5,a5,-1940 # 7950 <malloc+0x267e>
    ...
    110c:	30050513          	addi	a0,a0,768 # 5408 <malloc+0x136>
    1110:	4a5030ef          	jal	4db4 <exec>
    if(ret != -1){
    1114:	57fd                	li	a5,-1
    ...
    1120:	b2450513          	addi	a0,a0,-1244 # 5c40 <malloc+0x96e>
    1124:	0fa040ef          	jal	521e <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	a8450513          	addi	a0,a0,-1404 # 5bb8 <malloc+0x8e6>
    113c:	0e2040ef          	jal	521e <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	a8c50513          	addi	a0,a0,-1396 # 5bd8 <malloc+0x906>
    1154:	0ca040ef          	jal	521e <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	a9250513          	addi	a0,a0,-1390 # 5bf8 <malloc+0x926>
    116e:	0b0040ef          	jal	521e <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	aa250513          	addi	a0,a0,-1374 # 5c20 <malloc+0x94e>
    1186:	098040ef          	jal	521e <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	3e9030ef          	jal	4d74 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	0b050513          	addi	a0,a0,176 # 7240 <malloc+0x1f6e>
    1198:	086040ef          	jal	521e <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	a9e50513          	addi	a0,a0,-1378 # 5c68 <malloc+0x996>
    11d2:	04c040ef          	jal	521e <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	27450513          	addi	a0,a0,628 # 5460 <malloc+0x18e>
    11f4:	3c9030ef          	jal	4dbc <open>
    11f8:	3ad030ef          	jal	4da4 <close>
  pid = fork();
  ...
  if(pid == 0){
    ...
    1216:	24ea0a13          	addi	s4,s4,590 # 5460 <malloc+0x18e>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	aaea8a93          	addi	s5,s5,-1362 # 5cc8 <malloc+0x9f6>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    1226:	397030ef          	jal	4dbc <open>
    122a:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    1230:	4629                	li	a2,10
    1232:	85d6                	mv	a1,s5
    1234:	369030ef          	jal	4d9c <write>
      if(n != 10){
    1238:	47a9                	li	a5,10
    123a:	06f51163          	bne	a0,a5,129c <truncate3+0xc0>
      close(fd);
    123e:	8526                	mv	a0,s1
    1240:	365030ef          	jal	4da4 <close>
      fd = open("truncfile", O_RDONLY);
    1244:	4581                	li	a1,0
    1246:	8552                	mv	a0,s4
    1248:	375030ef          	jal	4dbc <open>
    124c:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    124e:	02000613          	li	a2,32
    1252:	f9840593          	addi	a1,s0,-104
    1256:	33f030ef          	jal	4d94 <read>
      close(fd);
    125a:	8526                	mv	a0,s1
    125c:	349030ef          	jal	4da4 <close>
    for(int i = 0; i < 100; i++){
    ...
    127a:	a2250513          	addi	a0,a0,-1502 # 5c98 <malloc+0x9c6>
    127e:	7a1030ef          	jal	521e <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	a2650513          	addi	a0,a0,-1498 # 5cb0 <malloc+0x9de>
    1292:	78d030ef          	jal	521e <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	a3850513          	addi	a0,a0,-1480 # 5cd8 <malloc+0xa06>
    12a8:	777030ef          	jal	521e <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	1a2a0a13          	addi	s4,s4,418 # 5460 <malloc+0x18e>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	a32a8a93          	addi	s5,s5,-1486 # 5cf8 <malloc+0xa26>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    12ce:	60100593          	li	a1,1537
    12d2:	8552                	mv	a0,s4
    12d4:	2e9030ef          	jal	4dbc <open>
    12d8:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    12de:	460d                	li	a2,3
    12e0:	85d6                	mv	a1,s5
    12e2:	2bb030ef          	jal	4d9c <write>
    if(n != 3){
    12e6:	478d                	li	a5,3
    12e8:	04f51063          	bne	a0,a5,1328 <truncate3+0x14c>
    close(fd);
    12ec:	8526                	mv	a0,s1
    12ee:	2b7030ef          	jal	4da4 <close>
  for(int i = 0; i < 150; i++){
  ...
  unlink("truncfile");
    ...
    1304:	16050513          	addi	a0,a0,352 # 5460 <malloc+0x18e>
    1308:	2c5030ef          	jal	4dcc <unlink>
  exit(xstatus);
    ...
    131a:	99a50513          	addi	a0,a0,-1638 # 5cb0 <malloc+0x9de>
    131e:	701030ef          	jal	521e <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	9d450513          	addi	a0,a0,-1580 # 5d00 <malloc+0xa2e>
    1334:	6eb030ef          	jal	521e <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	0be78793          	addi	a5,a5,190 # 5408 <malloc+0x136>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	9ca78793          	addi	a5,a5,-1590 # 5d20 <malloc+0xa4e>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	9c250513          	addi	a0,a0,-1598 # 5d28 <malloc+0xa56>
    136e:	25f030ef          	jal	4dcc <unlink>
  pid = fork();
  ...
  if(pid == 0) {
    ...
    close(1);
    1380:	4505                	li	a0,1
    1382:	223030ef          	jal	4da4 <close>
    fd = open("echo-ok", O_CREATE|O_WRONLY);
    1386:	20100593          	li	a1,513
    138a:	00005517          	auipc	a0,0x5
    138e:	99e50513          	addi	a0,a0,-1634 # 5d28 <malloc+0xa56>
    1392:	22b030ef          	jal	4dbc <open>
    if(fd < 0) {
    ...
    13a6:	9a650513          	addi	a0,a0,-1626 # 5d48 <malloc+0xa76>
    13aa:	675030ef          	jal	521e <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	8e050513          	addi	a0,a0,-1824 # 5c98 <malloc+0x9c6>
    13c0:	65f030ef          	jal	521e <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	96450513          	addi	a0,a0,-1692 # 5d30 <malloc+0xa5e>
    13d4:	64b030ef          	jal	521e <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	02650513          	addi	a0,a0,38 # 5408 <malloc+0x136>
    13ea:	1cb030ef          	jal	4db4 <exec>
  ...
  if(xstatus != 0)
    ...
    140e:	94e50513          	addi	a0,a0,-1714 # 5d58 <malloc+0xa86>
    1412:	60d030ef          	jal	521e <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	95250513          	addi	a0,a0,-1710 # 5d70 <malloc+0xa9e>
    1426:	5f9030ef          	jal	521e <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	8fa50513          	addi	a0,a0,-1798 # 5d28 <malloc+0xa56>
    1436:	187030ef          	jal	4dbc <open>
  if(fd < 0) {
    143a:	02054463          	bltz	a0,1462 <exectest+0x124>
  if (read(fd, buf, 2) != 2) {
    143e:	4609                	li	a2,2
    1440:	fb840593          	addi	a1,s0,-72
    1444:	151030ef          	jal	4d94 <read>
    1448:	4789                	li	a5,2
    144a:	02f50663          	beq	a0,a5,1476 <exectest+0x138>
    printf("%s: read failed\n", s);
    144e:	85ca                	mv	a1,s2
    1450:	00004517          	auipc	a0,0x4
    1454:	38850513          	addi	a0,a0,904 # 57d8 <malloc+0x506>
    1458:	5c7030ef          	jal	521e <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	84c50513          	addi	a0,a0,-1972 # 5cb0 <malloc+0x9de>
    146c:	5b3030ef          	jal	521e <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	103030ef          	jal	4d74 <exit>
  unlink("echo-ok");
    1476:	00005517          	auipc	a0,0x5
    147a:	8b250513          	addi	a0,a0,-1870 # 5d28 <malloc+0xa56>
    147e:	14f030ef          	jal	4dcc <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	8ec50513          	addi	a0,a0,-1812 # 5d88 <malloc+0xab6>
    14a4:	57b030ef          	jal	521e <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	85850513          	addi	a0,a0,-1960 # 5da0 <malloc+0xace>
    1550:	4cf030ef          	jal	521e <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	7f650513          	addi	a0,a0,2038 # 5db8 <malloc+0xae6>
    15ca:	455030ef          	jal	521e <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	7fa50513          	addi	a0,a0,2042 # 5dd0 <malloc+0xafe>
    15de:	441030ef          	jal	521e <printf>
          return;
    ...
    160a:	7e250513          	addi	a0,a0,2018 # 5de8 <malloc+0xb16>
    160e:	411030ef          	jal	521e <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	7ca50513          	addi	a0,a0,1994 # 5e08 <malloc+0xb36>
    1646:	3d9030ef          	jal	521e <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	5f850513          	addi	a0,a0,1528 # 5c98 <malloc+0x9c6>
    16a8:	377030ef          	jal	521e <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	76c50513          	addi	a0,a0,1900 # 5e20 <malloc+0xb4e>
    16bc:	363030ef          	jal	521e <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	77050513          	addi	a0,a0,1904 # 5e38 <malloc+0xb66>
    16d0:	34f030ef          	jal	521e <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	57450513          	addi	a0,a0,1396 # 5c98 <malloc+0x9c6>
    172c:	2f3030ef          	jal	521e <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	55c50513          	addi	a0,a0,1372 # 5c98 <malloc+0x9c6>
    1744:	2db030ef          	jal	521e <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	6be50513          	addi	a0,a0,1726 # 5e58 <malloc+0xb86>
    17a2:	27d030ef          	jal	521e <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	5cc030ef          	jal	4d74 <exit>
{
    ...
    17da:	69250513          	addi	a0,a0,1682 # 5e68 <malloc+0xb96>
    17de:	241030ef          	jal	521e <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	a3050513          	addi	a0,a0,-1488 # 7240 <malloc+0x1f6e>
    1818:	207030ef          	jal	521e <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	40650513          	addi	a0,a0,1030 # 5c98 <malloc+0x9c6>
    189a:	185030ef          	jal	521e <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	47a50513          	addi	a0,a0,1146 # 5d30 <malloc+0xa5e>
    18be:	161030ef          	jal	521e <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    18de:	4de030ef          	jal	4dbc <open>
        if(fd < 0){
    18e2:	fc0549e3          	bltz	a0,18b4 <createdelete+0x84>
        close(fd);
    18e6:	4be030ef          	jal	4da4 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    190a:	4c2030ef          	jal	4dcc <unlink>
    190e:	fa055de3          	bgez	a0,18c8 <createdelete+0x98>
            printf("%s: unlink failed\n", s);
    1912:	85e6                	mv	a1,s9
    1914:	00004517          	auipc	a0,0x4
    1918:	57450513          	addi	a0,a0,1396 # 5e88 <malloc+0xbb6>
    191c:	103030ef          	jal	521e <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	56850513          	addi	a0,a0,1384 # 5ea0 <malloc+0xbce>
    1940:	0df030ef          	jal	521e <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	53e50513          	addi	a0,a0,1342 # 5ec8 <malloc+0xbf6>
    1992:	08d030ef          	jal	521e <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	a5450513          	addi	a0,a0,-1452 # 5478 <malloc+0x1a6>
    1a2c:	3a0030ef          	jal	4dcc <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	a20b0b13          	addi	s6,s6,-1504 # 5478 <malloc+0x1a6>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	490c0c13          	addi	s8,s8,1168 # 5ef0 <malloc+0xc1e>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	22c50513          	addi	a0,a0,556 # 5c98 <malloc+0x9c6>
    1a74:	7aa030ef          	jal	521e <printf>
    exit(1);
    1a78:	4505                	li	a0,1
    ...
    1a82:	855a                	mv	a0,s6
    1a84:	338030ef          	jal	4dbc <open>
    1a88:	31c030ef          	jal	4da4 <close>
  for(i = 0; i < 100; i++){
    ...
    1aa4:	01778663          	beq	a5,s7,1ab0 <linkunlink+0xa8>
      unlink("x");
    1aa8:	855a                	mv	a0,s6
    1aaa:	322030ef          	jal	4dcc <unlink>
    1aae:	bff9                	j	1a8c <linkunlink+0x84>
      link("cat", "x");
    1ab0:	85da                	mv	a1,s6
    1ab2:	8562                	mv	a0,s8
    1ab4:	328030ef          	jal	4ddc <link>
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	43450513          	addi	a0,a0,1076 # 5f40 <malloc+0xc6e>
    1b14:	70a030ef          	jal	521e <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	3d450513          	addi	a0,a0,980 # 5ef8 <malloc+0xc26>
    1b2c:	6f2030ef          	jal	521e <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	3d850513          	addi	a0,a0,984 # 5f10 <malloc+0xc3e>
    1b40:	6de030ef          	jal	521e <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	3dc50513          	addi	a0,a0,988 # 5f28 <malloc+0xc56>
    1b54:	6ca030ef          	jal	521e <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	0ae50513          	addi	a0,a0,174 # 5c98 <malloc+0x9c6>
    1bf2:	62c030ef          	jal	521e <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	36450513          	addi	a0,a0,868 # 5f68 <malloc+0xc96>
    1c0c:	612030ef          	jal	521e <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	02650513          	addi	a0,a0,38 # 5c98 <malloc+0x9c6>
    1c7a:	5a4030ef          	jal	521e <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	2f250513          	addi	a0,a0,754 # 5f88 <malloc+0xcb6>
    1c9e:	580030ef          	jal	521e <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	2ba50513          	addi	a0,a0,698 # 5fa0 <malloc+0xcce>
    1cee:	530030ef          	jal	521e <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	f9e50513          	addi	a0,a0,-98 # 5c98 <malloc+0x9c6>
    1d02:	51c030ef          	jal	521e <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	c2e78793          	addi	a5,a5,-978 # 7950 <malloc+0x267e>
  ...
  exit(0);
    ...
    1d8e:	23e50513          	addi	a0,a0,574 # 5fc8 <malloc+0xcf6>
    1d92:	48c030ef          	jal	521e <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	efa50513          	addi	a0,a0,-262 # 5c98 <malloc+0x9c6>
    1da6:	478030ef          	jal	521e <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	43650513          	addi	a0,a0,1078 # 7240 <malloc+0x1f6e>
    1e12:	40c030ef          	jal	521e <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	14c50513          	addi	a0,a0,332 # 5fe8 <malloc+0xd16>
    1ea4:	37a030ef          	jal	521e <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	62450513          	addi	a0,a0,1572 # 54d8 <malloc+0x206>
    1ebc:	362030ef          	jal	521e <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    1f66:	09e50513          	addi	a0,a0,158 # 6000 <malloc+0xd2e>
    1f6a:	2b4030ef          	jal	521e <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	c4050513          	addi	a0,a0,-960 # 5bb8 <malloc+0x8e6>
    1f80:	29e030ef          	jal	521e <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	c4a50513          	addi	a0,a0,-950 # 5bd8 <malloc+0x906>
    1f96:	288030ef          	jal	521e <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	c5250513          	addi	a0,a0,-942 # 5bf8 <malloc+0x926>
    1fae:	270030ef          	jal	521e <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	c6450513          	addi	a0,a0,-924 # 5c20 <malloc+0x94e>
    1fc4:	25a030ef          	jal	521e <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	04850513          	addi	a0,a0,72 # 6040 <malloc+0xd6e>
    2000:	5bd020ef          	jal	4dbc <open>
    2004:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    2024:	04050513          	addi	a0,a0,64 # 6060 <malloc+0xd8e>
    2028:	1f6030ef          	jal	521e <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	fd250513          	addi	a0,a0,-46 # 6008 <malloc+0xd36>
    203e:	1e0030ef          	jal	521e <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	fd650513          	addi	a0,a0,-42 # 6020 <malloc+0xd4e>
    2052:	1cc030ef          	jal	521e <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	51d020ef          	jal	4d74 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	fec50513          	addi	a0,a0,-20 # 6048 <malloc+0xd76>
    2064:	1ba030ef          	jal	521e <printf>
    exit(1);
    2068:	4505                	li	a0,1
    206a:	50b020ef          	jal	4d74 <exit>
  close(fd);
    206e:	854a                	mv	a0,s2
    2070:	535020ef          	jal	4da4 <close>
  unlink("rwsbrk");
    2074:	00004517          	auipc	a0,0x4
    2078:	fcc50513          	addi	a0,a0,-52 # 6040 <malloc+0xd6e>
    207c:	551020ef          	jal	4dcc <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	55e50513          	addi	a0,a0,1374 # 55e0 <malloc+0x30e>
    208a:	533020ef          	jal	4dbc <open>
    208e:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    20a8:	fec50513          	addi	a0,a0,-20 # 6090 <malloc+0xdbe>
    20ac:	172030ef          	jal	521e <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	4c3020ef          	jal	4d74 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	53250513          	addi	a0,a0,1330 # 55e8 <malloc+0x316>
    20be:	160030ef          	jal	521e <printf>
    exit(1);
    20c2:	4505                	li	a0,1
    20c4:	4b1020ef          	jal	4d74 <exit>
  close(fd);
    20c8:	854a                	mv	a0,s2
    20ca:	4db020ef          	jal	4da4 <close>
  exit(0);
    20ce:	4501                	li	a0,0
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	f9850513          	addi	a0,a0,-104 # 60b8 <malloc+0xde6>
    2128:	0f6030ef          	jal	521e <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	f6850513          	addi	a0,a0,-152 # 60d8 <malloc+0xe06>
    2178:	0a6030ef          	jal	521e <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	f7c50513          	addi	a0,a0,-132 # 6138 <malloc+0xe66>
    21c4:	05a030ef          	jal	521e <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	f2250513          	addi	a0,a0,-222 # 60f8 <malloc+0xe26>
    21de:	040030ef          	jal	521e <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	f2e50513          	addi	a0,a0,-210 # 6118 <malloc+0xe46>
    21f2:	02c030ef          	jal	521e <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	e8650513          	addi	a0,a0,-378 # 6158 <malloc+0xe86>
    22da:	745020ef          	jal	521e <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	eba50513          	addi	a0,a0,-326 # 61a0 <malloc+0xece>
    22ee:	731020ef          	jal	521e <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	ec250513          	addi	a0,a0,-318 # 61c0 <malloc+0xeee>
    2306:	719020ef          	jal	521e <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	eea50513          	addi	a0,a0,-278 # 6200 <malloc+0xf2e>
    231e:	701020ef          	jal	521e <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	f0650513          	addi	a0,a0,-250 # 6230 <malloc+0xf5e>
    2332:	6ed020ef          	jal	521e <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	f2650513          	addi	a0,a0,-218 # 6268 <malloc+0xf96>
    234a:	6d5020ef          	jal	521e <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	f2050513          	addi	a0,a0,-224 # 6290 <malloc+0xfbe>
    2378:	245020ef          	jal	4dbc <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	f1250513          	addi	a0,a0,-238 # 6290 <malloc+0xfbe>
    2386:	247020ef          	jal	4dcc <unlink>
  if(fd < 0)  {
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	eda50513          	addi	a0,a0,-294 # 6298 <malloc+0xfc6>
    23c6:	659020ef          	jal	521e <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	ede50513          	addi	a0,a0,-290 # 62b0 <malloc+0xfde>
    23da:	645020ef          	jal	521e <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	9ba50513          	addi	a0,a0,-1606 # 5da0 <malloc+0xace>
    23ee:	631020ef          	jal	521e <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	ec050513          	addi	a0,a0,-320 # 62c8 <malloc+0xff6>
    2410:	1ad020ef          	jal	4dbc <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2426:	8526                	mv	a0,s1
    2428:	16d020ef          	jal	4d94 <read>
  close(fd);
    242c:	8526                	mv	a0,s1
    242e:	177020ef          	jal	4da4 <close>
}
    ...
    2444:	87050513          	addi	a0,a0,-1936 # 5cb0 <malloc+0x9de>
    2448:	5d7020ef          	jal	521e <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	dca50513          	addi	a0,a0,-566 # 7240 <malloc+0x1f6e>
    247e:	5a1020ef          	jal	521e <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	d9050513          	addi	a0,a0,-624 # 7240 <malloc+0x1f6e>
    24b8:	567020ef          	jal	521e <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	d5050513          	addi	a0,a0,-688 # 7240 <malloc+0x1f6e>
    24f8:	527020ef          	jal	521e <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
000000000000250e <sbrklast>:
{
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2558:	854a                	mv	a0,s2
    255a:	063020ef          	jal	4dbc <open>
    255e:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2560:	4605                	li	a2,1
    2562:	85ca                	mv	a1,s2
    2564:	039020ef          	jal	4d9c <write>
  close(fd);
    2568:	854e                	mv	a0,s3
    256a:	03b020ef          	jal	4da4 <close>
  fd = open(p, O_RDWR);
    256e:	4589                	li	a1,2
    2570:	854a                	mv	a0,s2
    2572:	04b020ef          	jal	4dbc <open>
  p[0] = '\0';
    2576:	fc048023          	sb	zero,-64(s1)
  read(fd, p, 1);
    257a:	4605                	li	a2,1
    257c:	85ca                	mv	a1,s2
    257e:	017020ef          	jal	4d94 <read>
  if(p[0] != 'x')
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	c3050513          	addi	a0,a0,-976 # 7240 <malloc+0x1f6e>
    2618:	407020ef          	jal	521e <printf>
      exit(1);
    261c:	4505                	li	a0,1
...
000000000000267a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    268a:	e1a50513          	addi	a0,a0,-486 # 64a0 <malloc+0x11ce>
    268e:	756020ef          	jal	4de4 <mkdir>
    2692:	e555                	bnez	a0,273e <fourteen+0xc4>
  if(mkdir("12345678901234/123456789012345") != 0){
    2694:	00004517          	auipc	a0,0x4
    2698:	c6450513          	addi	a0,a0,-924 # 62f8 <malloc+0x1026>
    269c:	748020ef          	jal	4de4 <mkdir>
    26a0:	e94d                	bnez	a0,2752 <fourteen+0xd8>
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    26a2:	20000593          	li	a1,512
    26a6:	00004517          	auipc	a0,0x4
    26aa:	caa50513          	addi	a0,a0,-854 # 6350 <malloc+0x107e>
    26ae:	70e020ef          	jal	4dbc <open>
  if(fd < 0){
    26b2:	0a054a63          	bltz	a0,2766 <fourteen+0xec>
  close(fd);
    26b6:	6ee020ef          	jal	4da4 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    26ba:	4581                	li	a1,0
    26bc:	00004517          	auipc	a0,0x4
    26c0:	d0c50513          	addi	a0,a0,-756 # 63c8 <malloc+0x10f6>
    26c4:	6f8020ef          	jal	4dbc <open>
  if(fd < 0){
    26c8:	0a054963          	bltz	a0,277a <fourteen+0x100>
  close(fd);
    26cc:	6d8020ef          	jal	4da4 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    26d0:	00004517          	auipc	a0,0x4
    26d4:	d6850513          	addi	a0,a0,-664 # 6438 <malloc+0x1166>
    26d8:	70c020ef          	jal	4de4 <mkdir>
    26dc:	c94d                	beqz	a0,278e <fourteen+0x114>
  if(mkdir("123456789012345/12345678901234") == 0){
    26de:	00004517          	auipc	a0,0x4
    26e2:	db250513          	addi	a0,a0,-590 # 6490 <malloc+0x11be>
    26e6:	6fe020ef          	jal	4de4 <mkdir>
    26ea:	cd45                	beqz	a0,27a2 <fourteen+0x128>
  unlink("123456789012345/12345678901234");
    26ec:	00004517          	auipc	a0,0x4
    26f0:	da450513          	addi	a0,a0,-604 # 6490 <malloc+0x11be>
    26f4:	6d8020ef          	jal	4dcc <unlink>
  unlink("12345678901234/12345678901234");
    26f8:	00004517          	auipc	a0,0x4
    26fc:	d4050513          	addi	a0,a0,-704 # 6438 <malloc+0x1166>
    2700:	6cc020ef          	jal	4dcc <unlink>
  unlink("12345678901234/12345678901234/12345678901234");
    2704:	00004517          	auipc	a0,0x4
    2708:	cc450513          	addi	a0,a0,-828 # 63c8 <malloc+0x10f6>
    270c:	6c0020ef          	jal	4dcc <unlink>
  unlink("123456789012345/123456789012345/123456789012345");
    2710:	00004517          	auipc	a0,0x4
    2714:	c4050513          	addi	a0,a0,-960 # 6350 <malloc+0x107e>
    2718:	6b4020ef          	jal	4dcc <unlink>
  unlink("12345678901234/123456789012345");
    271c:	00004517          	auipc	a0,0x4
    2720:	bdc50513          	addi	a0,a0,-1060 # 62f8 <malloc+0x1026>
    2724:	6a8020ef          	jal	4dcc <unlink>
  unlink("12345678901234");
    2728:	00004517          	auipc	a0,0x4
    272c:	d7850513          	addi	a0,a0,-648 # 64a0 <malloc+0x11ce>
    2730:	69c020ef          	jal	4dcc <unlink>
}
    ...
    2744:	b9050513          	addi	a0,a0,-1136 # 62d0 <malloc+0xffe>
    2748:	2d7020ef          	jal	521e <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	bc450513          	addi	a0,a0,-1084 # 6318 <malloc+0x1046>
    275c:	2c3020ef          	jal	521e <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	c1850513          	addi	a0,a0,-1000 # 6380 <malloc+0x10ae>
    2770:	2af020ef          	jal	521e <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	c7c50513          	addi	a0,a0,-900 # 63f8 <malloc+0x1126>
    2784:	29b020ef          	jal	521e <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	cc850513          	addi	a0,a0,-824 # 6458 <malloc+0x1186>
    2798:	287020ef          	jal	521e <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	d0c50513          	addi	a0,a0,-756 # 64b0 <malloc+0x11de>
    27ac:	273020ef          	jal	521e <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	cfc50513          	addi	a0,a0,-772 # 64e8 <malloc+0x1216>
    27f4:	5d8020ef          	jal	4dcc <unlink>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	ce050513          	addi	a0,a0,-800 # 64f8 <malloc+0x1226>
    2820:	1ff020ef          	jal	521e <printf>
      break;
    2824:	a039                	j	2832 <diskfull+0x7c>
        close(fd);
    2826:	854a                	mv	a0,s2
    2828:	57c020ef          	jal	4da4 <close>
    close(fd);
    282c:	854a                	mv	a0,s2
    282e:	576020ef          	jal	4da4 <close>
  for(int i = 0; i < nzz; i++){
    2832:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2986:	446020ef          	jal	4dcc <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    298a:	60200593          	li	a1,1538
    298e:	b8040513          	addi	a0,s0,-1152
    2992:	42a020ef          	jal	4dbc <open>
    2996:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    29c0:	b5c50513          	addi	a0,a0,-1188 # 6518 <malloc+0x1246>
    29c4:	05b020ef          	jal	521e <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    29da:	b7250513          	addi	a0,a0,-1166 # 6548 <malloc+0x1276>
    29de:	406020ef          	jal	4de4 <mkdir>
    29e2:	02054f63          	bltz	a0,2a20 <iputtest+0x56>
  if(chdir("iputdir") < 0){
    29e6:	00004517          	auipc	a0,0x4
    29ea:	b6250513          	addi	a0,a0,-1182 # 6548 <malloc+0x1276>
    29ee:	3fe020ef          	jal	4dec <chdir>
    29f2:	04054163          	bltz	a0,2a34 <iputtest+0x6a>
  if(unlink("../iputdir") < 0){
    29f6:	00004517          	auipc	a0,0x4
    29fa:	b9250513          	addi	a0,a0,-1134 # 6588 <malloc+0x12b6>
    29fe:	3ce020ef          	jal	4dcc <unlink>
    2a02:	04054363          	bltz	a0,2a48 <iputtest+0x7e>
  if(chdir("/") < 0){
    2a06:	00004517          	auipc	a0,0x4
    2a0a:	bb250513          	addi	a0,a0,-1102 # 65b8 <malloc+0x12e6>
    2a0e:	3de020ef          	jal	4dec <chdir>
    ...
    2a26:	b2e50513          	addi	a0,a0,-1234 # 6550 <malloc+0x127e>
    2a2a:	7f4020ef          	jal	521e <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	b3250513          	addi	a0,a0,-1230 # 6568 <malloc+0x1296>
    2a3e:	7e0020ef          	jal	521e <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	b4e50513          	addi	a0,a0,-1202 # 6598 <malloc+0x12c6>
    2a52:	7cc020ef          	jal	521e <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	b6250513          	addi	a0,a0,-1182 # 65c0 <malloc+0x12ee>
    2a66:	7b8020ef          	jal	521e <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2a8a:	ac250513          	addi	a0,a0,-1342 # 6548 <malloc+0x1276>
    2a8e:	356020ef          	jal	4de4 <mkdir>
    2a92:	02054f63          	bltz	a0,2ad0 <exitiputtest+0x60>
    if(chdir("iputdir") < 0){
    2a96:	00004517          	auipc	a0,0x4
    2a9a:	ab250513          	addi	a0,a0,-1358 # 6548 <malloc+0x1276>
    2a9e:	34e020ef          	jal	4dec <chdir>
    2aa2:	04054163          	bltz	a0,2ae4 <exitiputtest+0x74>
    if(unlink("../iputdir") < 0){
    2aa6:	00004517          	auipc	a0,0x4
    2aaa:	ae250513          	addi	a0,a0,-1310 # 6588 <malloc+0x12b6>
    2aae:	31e020ef          	jal	4dcc <unlink>
    ...
    2ac2:	1da50513          	addi	a0,a0,474 # 5c98 <malloc+0x9c6>
    2ac6:	758020ef          	jal	521e <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	a7e50513          	addi	a0,a0,-1410 # 6550 <malloc+0x127e>
    2ada:	744020ef          	jal	521e <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	af250513          	addi	a0,a0,-1294 # 65d8 <malloc+0x1306>
    2aee:	730020ef          	jal	521e <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	a9e50513          	addi	a0,a0,-1378 # 6598 <malloc+0x12c6>
    2b02:	71c020ef          	jal	521e <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2b2c:	ac850513          	addi	a0,a0,-1336 # 65f0 <malloc+0x131e>
    2b30:	2b4020ef          	jal	4de4 <mkdir>
    2b34:	02054f63          	bltz	a0,2b72 <dirtest+0x56>
  if(chdir("dir0") < 0){
    2b38:	00004517          	auipc	a0,0x4
    2b3c:	ab850513          	addi	a0,a0,-1352 # 65f0 <malloc+0x131e>
    2b40:	2ac020ef          	jal	4dec <chdir>
    2b44:	04054163          	bltz	a0,2b86 <dirtest+0x6a>
  if(chdir("..") < 0){
    2b48:	00004517          	auipc	a0,0x4
    2b4c:	ac850513          	addi	a0,a0,-1336 # 6610 <malloc+0x133e>
    2b50:	29c020ef          	jal	4dec <chdir>
    2b54:	04054363          	bltz	a0,2b9a <dirtest+0x7e>
  if(unlink("dir0") < 0){
    2b58:	00004517          	auipc	a0,0x4
    2b5c:	a9850513          	addi	a0,a0,-1384 # 65f0 <malloc+0x131e>
    2b60:	26c020ef          	jal	4dcc <unlink>
    ...
    2b78:	9dc50513          	addi	a0,a0,-1572 # 6550 <malloc+0x127e>
    2b7c:	6a2020ef          	jal	521e <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	a7050513          	addi	a0,a0,-1424 # 65f8 <malloc+0x1326>
    2b90:	68e020ef          	jal	521e <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	a7c50513          	addi	a0,a0,-1412 # 6618 <malloc+0x1346>
    2ba4:	67a020ef          	jal	521e <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	a8050513          	addi	a0,a0,-1408 # 6630 <malloc+0x135e>
    2bb8:	666020ef          	jal	521e <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	ba850513          	addi	a0,a0,-1112 # 6778 <malloc+0x14a6>
    2bd8:	1f4020ef          	jal	4dcc <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	a6c50513          	addi	a0,a0,-1428 # 6648 <malloc+0x1376>
    2be4:	200020ef          	jal	4de4 <mkdir>
    2be8:	2e051263          	bnez	a0,2ecc <subdir+0x30a>
  fd = open("dd/ff", O_CREATE | O_RDWR);
    2bec:	20200593          	li	a1,514
    2bf0:	00004517          	auipc	a0,0x4
    2bf4:	a7850513          	addi	a0,a0,-1416 # 6668 <malloc+0x1396>
    2bf8:	1c4020ef          	jal	4dbc <open>
    2bfc:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    2c08:	b7458593          	addi	a1,a1,-1164 # 6778 <malloc+0x14a6>
    2c0c:	190020ef          	jal	4d9c <write>
  close(fd);
    2c10:	8526                	mv	a0,s1
    2c12:	192020ef          	jal	4da4 <close>
  if(unlink("dd") >= 0){
    2c16:	00004517          	auipc	a0,0x4
    2c1a:	a3250513          	addi	a0,a0,-1486 # 6648 <malloc+0x1376>
    2c1e:	1ae020ef          	jal	4dcc <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a9a50513          	addi	a0,a0,-1382 # 66c0 <malloc+0x13ee>
    2c2e:	1b6020ef          	jal	4de4 <mkdir>
    2c32:	2c051b63          	bnez	a0,2f08 <subdir+0x346>
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2c36:	20200593          	li	a1,514
    2c3a:	00004517          	auipc	a0,0x4
    2c3e:	aae50513          	addi	a0,a0,-1362 # 66e8 <malloc+0x1416>
    2c42:	17a020ef          	jal	4dbc <open>
    2c46:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    2c52:	aca58593          	addi	a1,a1,-1334 # 6718 <malloc+0x1446>
    2c56:	146020ef          	jal	4d9c <write>
  close(fd);
    2c5a:	8526                	mv	a0,s1
    2c5c:	148020ef          	jal	4da4 <close>
  fd = open("dd/dd/../ff", 0);
    2c60:	4581                	li	a1,0
    2c62:	00004517          	auipc	a0,0x4
    2c66:	abe50513          	addi	a0,a0,-1346 # 6720 <malloc+0x144e>
    2c6a:	152020ef          	jal	4dbc <open>
    2c6e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  close(fd);
    2c98:	8526                	mv	a0,s1
    2c9a:	10a020ef          	jal	4da4 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2c9e:	00004597          	auipc	a1,0x4
    2ca2:	ad258593          	addi	a1,a1,-1326 # 6770 <malloc+0x149e>
    2ca6:	00004517          	auipc	a0,0x4
    2caa:	a4250513          	addi	a0,a0,-1470 # 66e8 <malloc+0x1416>
    2cae:	12e020ef          	jal	4ddc <link>
    2cb2:	2a051363          	bnez	a0,2f58 <subdir+0x396>
  if(unlink("dd/dd/ff") != 0){
    2cb6:	00004517          	auipc	a0,0x4
    2cba:	a3250513          	addi	a0,a0,-1486 # 66e8 <malloc+0x1416>
    2cbe:	10e020ef          	jal	4dcc <unlink>
    2cc2:	2a051563          	bnez	a0,2f6c <subdir+0x3aa>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2cc6:	4581                	li	a1,0
    2cc8:	00004517          	auipc	a0,0x4
    2ccc:	a2050513          	addi	a0,a0,-1504 # 66e8 <malloc+0x1416>
    2cd0:	0ec020ef          	jal	4dbc <open>
    2cd4:	2a055663          	bgez	a0,2f80 <subdir+0x3be>
  if(chdir("dd") != 0){
    2cd8:	00004517          	auipc	a0,0x4
    2cdc:	97050513          	addi	a0,a0,-1680 # 6648 <malloc+0x1376>
    2ce0:	10c020ef          	jal	4dec <chdir>
    2ce4:	2a051863          	bnez	a0,2f94 <subdir+0x3d2>
  if(chdir("dd/../../dd") != 0){
    2ce8:	00004517          	auipc	a0,0x4
    2cec:	b2050513          	addi	a0,a0,-1248 # 6808 <malloc+0x1536>
    2cf0:	0fc020ef          	jal	4dec <chdir>
    2cf4:	2a051a63          	bnez	a0,2fa8 <subdir+0x3e6>
  if(chdir("dd/../../../dd") != 0){
    2cf8:	00004517          	auipc	a0,0x4
    2cfc:	b4050513          	addi	a0,a0,-1216 # 6838 <malloc+0x1566>
    2d00:	0ec020ef          	jal	4dec <chdir>
    2d04:	2a051c63          	bnez	a0,2fbc <subdir+0x3fa>
  if(chdir("./..") != 0){
    2d08:	00004517          	auipc	a0,0x4
    2d0c:	b6850513          	addi	a0,a0,-1176 # 6870 <malloc+0x159e>
    2d10:	0dc020ef          	jal	4dec <chdir>
    2d14:	2a051e63          	bnez	a0,2fd0 <subdir+0x40e>
  fd = open("dd/dd/ffff", 0);
    2d18:	4581                	li	a1,0
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	a5650513          	addi	a0,a0,-1450 # 6770 <malloc+0x149e>
    2d22:	09a020ef          	jal	4dbc <open>
    2d26:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2d36:	05e020ef          	jal	4d94 <read>
    2d3a:	4789                	li	a5,2
    2d3c:	2af51e63          	bne	a0,a5,2ff8 <subdir+0x436>
  close(fd);
    2d40:	8526                	mv	a0,s1
    2d42:	062020ef          	jal	4da4 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2d46:	4581                	li	a1,0
    2d48:	00004517          	auipc	a0,0x4
    2d4c:	9a050513          	addi	a0,a0,-1632 # 66e8 <malloc+0x1416>
    2d50:	06c020ef          	jal	4dbc <open>
    2d54:	2a055c63          	bgez	a0,300c <subdir+0x44a>
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2d58:	20200593          	li	a1,514
    2d5c:	00004517          	auipc	a0,0x4
    2d60:	ba450513          	addi	a0,a0,-1116 # 6900 <malloc+0x162e>
    2d64:	058020ef          	jal	4dbc <open>
    2d68:	2a055c63          	bgez	a0,3020 <subdir+0x45e>
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2d6c:	20200593          	li	a1,514
    2d70:	00004517          	auipc	a0,0x4
    2d74:	bc050513          	addi	a0,a0,-1088 # 6930 <malloc+0x165e>
    2d78:	044020ef          	jal	4dbc <open>
    2d7c:	2a055c63          	bgez	a0,3034 <subdir+0x472>
  if(open("dd", O_CREATE) >= 0){
    2d80:	20000593          	li	a1,512
    2d84:	00004517          	auipc	a0,0x4
    2d88:	8c450513          	addi	a0,a0,-1852 # 6648 <malloc+0x1376>
    2d8c:	030020ef          	jal	4dbc <open>
    2d90:	2a055c63          	bgez	a0,3048 <subdir+0x486>
  if(open("dd", O_RDWR) >= 0){
    2d94:	4589                	li	a1,2
    2d96:	00004517          	auipc	a0,0x4
    2d9a:	8b250513          	addi	a0,a0,-1870 # 6648 <malloc+0x1376>
    2d9e:	01e020ef          	jal	4dbc <open>
    2da2:	2a055d63          	bgez	a0,305c <subdir+0x49a>
  if(open("dd", O_WRONLY) >= 0){
    2da6:	4585                	li	a1,1
    2da8:	00004517          	auipc	a0,0x4
    2dac:	8a050513          	addi	a0,a0,-1888 # 6648 <malloc+0x1376>
    2db0:	00c020ef          	jal	4dbc <open>
    2db4:	2a055e63          	bgez	a0,3070 <subdir+0x4ae>
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2db8:	00004597          	auipc	a1,0x4
    2dbc:	c0858593          	addi	a1,a1,-1016 # 69c0 <malloc+0x16ee>
    2dc0:	00004517          	auipc	a0,0x4
    2dc4:	b4050513          	addi	a0,a0,-1216 # 6900 <malloc+0x162e>
    2dc8:	014020ef          	jal	4ddc <link>
    2dcc:	2a050c63          	beqz	a0,3084 <subdir+0x4c2>
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2dd0:	00004597          	auipc	a1,0x4
    2dd4:	bf058593          	addi	a1,a1,-1040 # 69c0 <malloc+0x16ee>
    2dd8:	00004517          	auipc	a0,0x4
    2ddc:	b5850513          	addi	a0,a0,-1192 # 6930 <malloc+0x165e>
    2de0:	7fd010ef          	jal	4ddc <link>
    2de4:	2a050a63          	beqz	a0,3098 <subdir+0x4d6>
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2de8:	00004597          	auipc	a1,0x4
    2dec:	98858593          	addi	a1,a1,-1656 # 6770 <malloc+0x149e>
    2df0:	00004517          	auipc	a0,0x4
    2df4:	87850513          	addi	a0,a0,-1928 # 6668 <malloc+0x1396>
    2df8:	7e5010ef          	jal	4ddc <link>
    2dfc:	2a050863          	beqz	a0,30ac <subdir+0x4ea>
  if(mkdir("dd/ff/ff") == 0){
    2e00:	00004517          	auipc	a0,0x4
    2e04:	b0050513          	addi	a0,a0,-1280 # 6900 <malloc+0x162e>
    2e08:	7dd010ef          	jal	4de4 <mkdir>
    2e0c:	2a050a63          	beqz	a0,30c0 <subdir+0x4fe>
  if(mkdir("dd/xx/ff") == 0){
    2e10:	00004517          	auipc	a0,0x4
    2e14:	b2050513          	addi	a0,a0,-1248 # 6930 <malloc+0x165e>
    2e18:	7cd010ef          	jal	4de4 <mkdir>
    2e1c:	2a050c63          	beqz	a0,30d4 <subdir+0x512>
  if(mkdir("dd/dd/ffff") == 0){
    2e20:	00004517          	auipc	a0,0x4
    2e24:	95050513          	addi	a0,a0,-1712 # 6770 <malloc+0x149e>
    2e28:	7bd010ef          	jal	4de4 <mkdir>
    2e2c:	2a050e63          	beqz	a0,30e8 <subdir+0x526>
  if(unlink("dd/xx/ff") == 0){
    2e30:	00004517          	auipc	a0,0x4
    2e34:	b0050513          	addi	a0,a0,-1280 # 6930 <malloc+0x165e>
    2e38:	795010ef          	jal	4dcc <unlink>
    2e3c:	2c050063          	beqz	a0,30fc <subdir+0x53a>
  if(unlink("dd/ff/ff") == 0){
    2e40:	00004517          	auipc	a0,0x4
    2e44:	ac050513          	addi	a0,a0,-1344 # 6900 <malloc+0x162e>
    2e48:	785010ef          	jal	4dcc <unlink>
    2e4c:	2c050263          	beqz	a0,3110 <subdir+0x54e>
  if(chdir("dd/ff") == 0){
    2e50:	00004517          	auipc	a0,0x4
    2e54:	81850513          	addi	a0,a0,-2024 # 6668 <malloc+0x1396>
    2e58:	795010ef          	jal	4dec <chdir>
    2e5c:	2c050463          	beqz	a0,3124 <subdir+0x562>
  if(chdir("dd/xx") == 0){
    2e60:	00004517          	auipc	a0,0x4
    2e64:	cb050513          	addi	a0,a0,-848 # 6b10 <malloc+0x183e>
    2e68:	785010ef          	jal	4dec <chdir>
    2e6c:	2c050663          	beqz	a0,3138 <subdir+0x576>
  if(unlink("dd/dd/ffff") != 0){
    2e70:	00004517          	auipc	a0,0x4
    2e74:	90050513          	addi	a0,a0,-1792 # 6770 <malloc+0x149e>
    2e78:	755010ef          	jal	4dcc <unlink>
    2e7c:	2c051863          	bnez	a0,314c <subdir+0x58a>
  if(unlink("dd/ff") != 0){
    2e80:	00003517          	auipc	a0,0x3
    2e84:	7e850513          	addi	a0,a0,2024 # 6668 <malloc+0x1396>
    2e88:	745010ef          	jal	4dcc <unlink>
    2e8c:	2c051a63          	bnez	a0,3160 <subdir+0x59e>
  if(unlink("dd") == 0){
    2e90:	00003517          	auipc	a0,0x3
    2e94:	7b850513          	addi	a0,a0,1976 # 6648 <malloc+0x1376>
    2e98:	735010ef          	jal	4dcc <unlink>
    2e9c:	2c050c63          	beqz	a0,3174 <subdir+0x5b2>
  if(unlink("dd/dd") < 0){
    2ea0:	00004517          	auipc	a0,0x4
    2ea4:	ce050513          	addi	a0,a0,-800 # 6b80 <malloc+0x18ae>
    2ea8:	725010ef          	jal	4dcc <unlink>
    2eac:	2c054e63          	bltz	a0,3188 <subdir+0x5c6>
  if(unlink("dd") < 0){
    2eb0:	00003517          	auipc	a0,0x3
    2eb4:	79850513          	addi	a0,a0,1944 # 6648 <malloc+0x1376>
    2eb8:	715010ef          	jal	4dcc <unlink>
    ...
    2ed2:	78250513          	addi	a0,a0,1922 # 6650 <malloc+0x137e>
    2ed6:	348020ef          	jal	521e <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	78e50513          	addi	a0,a0,1934 # 6670 <malloc+0x139e>
    2eea:	334020ef          	jal	521e <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	79a50513          	addi	a0,a0,1946 # 6690 <malloc+0x13be>
    2efe:	320020ef          	jal	521e <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	7be50513          	addi	a0,a0,1982 # 66c8 <malloc+0x13f6>
    2f12:	30c020ef          	jal	521e <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	7da50513          	addi	a0,a0,2010 # 66f8 <malloc+0x1426>
    2f26:	2f8020ef          	jal	521e <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	7fe50513          	addi	a0,a0,2046 # 6730 <malloc+0x145e>
    2f3a:	2e4020ef          	jal	521e <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	80a50513          	addi	a0,a0,-2038 # 6750 <malloc+0x147e>
    2f4e:	2d0020ef          	jal	521e <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	82650513          	addi	a0,a0,-2010 # 6780 <malloc+0x14ae>
    2f62:	2bc020ef          	jal	521e <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	83a50513          	addi	a0,a0,-1990 # 67a8 <malloc+0x14d6>
    2f76:	2a8020ef          	jal	521e <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	84650513          	addi	a0,a0,-1978 # 67c8 <malloc+0x14f6>
    2f8a:	294020ef          	jal	521e <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	85a50513          	addi	a0,a0,-1958 # 67f0 <malloc+0x151e>
    2f9e:	280020ef          	jal	521e <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	86e50513          	addi	a0,a0,-1938 # 6818 <malloc+0x1546>
    2fb2:	26c020ef          	jal	521e <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	88a50513          	addi	a0,a0,-1910 # 6848 <malloc+0x1576>
    2fc6:	258020ef          	jal	521e <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	8a650513          	addi	a0,a0,-1882 # 6878 <malloc+0x15a6>
    2fda:	244020ef          	jal	521e <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	8aa50513          	addi	a0,a0,-1878 # 6890 <malloc+0x15be>
    2fee:	230020ef          	jal	521e <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	8b650513          	addi	a0,a0,-1866 # 68b0 <malloc+0x15de>
    3002:	21c020ef          	jal	521e <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	8c250513          	addi	a0,a0,-1854 # 68d0 <malloc+0x15fe>
    3016:	208020ef          	jal	521e <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	8ee50513          	addi	a0,a0,-1810 # 6910 <malloc+0x163e>
    302a:	1f4020ef          	jal	521e <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	90a50513          	addi	a0,a0,-1782 # 6940 <malloc+0x166e>
    303e:	1e0020ef          	jal	521e <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	91650513          	addi	a0,a0,-1770 # 6960 <malloc+0x168e>
    3052:	1cc020ef          	jal	521e <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	92250513          	addi	a0,a0,-1758 # 6980 <malloc+0x16ae>
    3066:	1b8020ef          	jal	521e <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	92e50513          	addi	a0,a0,-1746 # 69a0 <malloc+0x16ce>
    307a:	1a4020ef          	jal	521e <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	94a50513          	addi	a0,a0,-1718 # 69d0 <malloc+0x16fe>
    308e:	190020ef          	jal	521e <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	95e50513          	addi	a0,a0,-1698 # 69f8 <malloc+0x1726>
    30a2:	17c020ef          	jal	521e <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	97250513          	addi	a0,a0,-1678 # 6a20 <malloc+0x174e>
    30b6:	168020ef          	jal	521e <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	98650513          	addi	a0,a0,-1658 # 6a48 <malloc+0x1776>
    30ca:	154020ef          	jal	521e <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	99250513          	addi	a0,a0,-1646 # 6a68 <malloc+0x1796>
    30de:	140020ef          	jal	521e <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	99e50513          	addi	a0,a0,-1634 # 6a88 <malloc+0x17b6>
    30f2:	12c020ef          	jal	521e <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	9b250513          	addi	a0,a0,-1614 # 6ab0 <malloc+0x17de>
    3106:	118020ef          	jal	521e <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	9be50513          	addi	a0,a0,-1602 # 6ad0 <malloc+0x17fe>
    311a:	104020ef          	jal	521e <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	9ca50513          	addi	a0,a0,-1590 # 6af0 <malloc+0x181e>
    312e:	0f0020ef          	jal	521e <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	9de50513          	addi	a0,a0,-1570 # 6b18 <malloc+0x1846>
    3142:	0dc020ef          	jal	521e <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	65a50513          	addi	a0,a0,1626 # 67a8 <malloc+0x14d6>
    3156:	0c8020ef          	jal	521e <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	9d650513          	addi	a0,a0,-1578 # 6b38 <malloc+0x1866>
    316a:	0b4020ef          	jal	521e <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	9e250513          	addi	a0,a0,-1566 # 6b58 <malloc+0x1886>
    317e:	0a0020ef          	jal	521e <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	9fe50513          	addi	a0,a0,-1538 # 6b88 <malloc+0x18b6>
    3192:	08c020ef          	jal	521e <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	a0a50513          	addi	a0,a0,-1526 # 6ba8 <malloc+0x18d6>
    31a6:	078020ef          	jal	521e <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    31c0:	a0450513          	addi	a0,a0,-1532 # 6bc0 <malloc+0x18ee>
    31c4:	421010ef          	jal	4de4 <mkdir>
    31c8:	e53d                	bnez	a0,3236 <rmdot+0x86>
  if(chdir("dots") != 0){
    31ca:	00004517          	auipc	a0,0x4
    31ce:	9f650513          	addi	a0,a0,-1546 # 6bc0 <malloc+0x18ee>
    31d2:	41b010ef          	jal	4dec <chdir>
    31d6:	e935                	bnez	a0,324a <rmdot+0x9a>
  if(unlink(".") == 0){
    31d8:	00003517          	auipc	a0,0x3
    31dc:	91850513          	addi	a0,a0,-1768 # 5af0 <malloc+0x81e>
    31e0:	3ed010ef          	jal	4dcc <unlink>
    31e4:	cd2d                	beqz	a0,325e <rmdot+0xae>
  if(unlink("..") == 0){
    31e6:	00003517          	auipc	a0,0x3
    31ea:	42a50513          	addi	a0,a0,1066 # 6610 <malloc+0x133e>
    31ee:	3df010ef          	jal	4dcc <unlink>
    31f2:	c141                	beqz	a0,3272 <rmdot+0xc2>
  if(chdir("/") != 0){
    31f4:	00003517          	auipc	a0,0x3
    31f8:	3c450513          	addi	a0,a0,964 # 65b8 <malloc+0x12e6>
    31fc:	3f1010ef          	jal	4dec <chdir>
    3200:	e159                	bnez	a0,3286 <rmdot+0xd6>
  if(unlink("dots/.") == 0){
    3202:	00004517          	auipc	a0,0x4
    3206:	a2650513          	addi	a0,a0,-1498 # 6c28 <malloc+0x1956>
    320a:	3c3010ef          	jal	4dcc <unlink>
    320e:	c551                	beqz	a0,329a <rmdot+0xea>
  if(unlink("dots/..") == 0){
    3210:	00004517          	auipc	a0,0x4
    3214:	a4050513          	addi	a0,a0,-1472 # 6c50 <malloc+0x197e>
    3218:	3b5010ef          	jal	4dcc <unlink>
    321c:	c949                	beqz	a0,32ae <rmdot+0xfe>
  if(unlink("dots") != 0){
    321e:	00004517          	auipc	a0,0x4
    3222:	9a250513          	addi	a0,a0,-1630 # 6bc0 <malloc+0x18ee>
    3226:	3a7010ef          	jal	4dcc <unlink>
    ...
    323c:	99050513          	addi	a0,a0,-1648 # 6bc8 <malloc+0x18f6>
    3240:	7df010ef          	jal	521e <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	99450513          	addi	a0,a0,-1644 # 6be0 <malloc+0x190e>
    3254:	7cb010ef          	jal	521e <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	99850513          	addi	a0,a0,-1640 # 6bf8 <malloc+0x1926>
    3268:	7b7010ef          	jal	521e <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	99c50513          	addi	a0,a0,-1636 # 6c10 <malloc+0x193e>
    327c:	7a3010ef          	jal	521e <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	33850513          	addi	a0,a0,824 # 65c0 <malloc+0x12ee>
    3290:	78f010ef          	jal	521e <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	99450513          	addi	a0,a0,-1644 # 6c30 <malloc+0x195e>
    32a4:	77b010ef          	jal	521e <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	9a850513          	addi	a0,a0,-1624 # 6c58 <malloc+0x1986>
    32b8:	767010ef          	jal	521e <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	9b450513          	addi	a0,a0,-1612 # 6c78 <malloc+0x19a6>
    32cc:	753010ef          	jal	521e <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	9b050513          	addi	a0,a0,-1616 # 6c98 <malloc+0x19c6>
    32f0:	2cd010ef          	jal	4dbc <open>
  if(fd < 0){
    32f4:	0c054563          	bltz	a0,33be <dirfile+0xe8>
  close(fd);
    32f8:	2ad010ef          	jal	4da4 <close>
  if(chdir("dirfile") == 0){
    32fc:	00004517          	auipc	a0,0x4
    3300:	99c50513          	addi	a0,a0,-1636 # 6c98 <malloc+0x19c6>
    3304:	2e9010ef          	jal	4dec <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	9d450513          	addi	a0,a0,-1580 # 6ce0 <malloc+0x1a0e>
    3314:	2a9010ef          	jal	4dbc <open>
  if(fd >= 0){
    3318:	0c055763          	bgez	a0,33e6 <dirfile+0x110>
  fd = open("dirfile/xx", O_CREATE);
    331c:	20000593          	li	a1,512
    3320:	00004517          	auipc	a0,0x4
    3324:	9c050513          	addi	a0,a0,-1600 # 6ce0 <malloc+0x1a0e>
    3328:	295010ef          	jal	4dbc <open>
  if(fd >= 0){
    332c:	0c055763          	bgez	a0,33fa <dirfile+0x124>
  if(mkdir("dirfile/xx") == 0){
    3330:	00004517          	auipc	a0,0x4
    3334:	9b050513          	addi	a0,a0,-1616 # 6ce0 <malloc+0x1a0e>
    3338:	2ad010ef          	jal	4de4 <mkdir>
    333c:	0c050963          	beqz	a0,340e <dirfile+0x138>
  if(unlink("dirfile/xx") == 0){
    3340:	00004517          	auipc	a0,0x4
    3344:	9a050513          	addi	a0,a0,-1632 # 6ce0 <malloc+0x1a0e>
    3348:	285010ef          	jal	4dcc <unlink>
    334c:	0c050b63          	beqz	a0,3422 <dirfile+0x14c>
  if(link("README", "dirfile/xx") == 0){
    3350:	00004597          	auipc	a1,0x4
    3354:	99058593          	addi	a1,a1,-1648 # 6ce0 <malloc+0x1a0e>
    3358:	00002517          	auipc	a0,0x2
    335c:	28850513          	addi	a0,a0,648 # 55e0 <malloc+0x30e>
    3360:	27d010ef          	jal	4ddc <link>
    3364:	0c050963          	beqz	a0,3436 <dirfile+0x160>
  if(unlink("dirfile") != 0){
    3368:	00004517          	auipc	a0,0x4
    336c:	93050513          	addi	a0,a0,-1744 # 6c98 <malloc+0x19c6>
    3370:	25d010ef          	jal	4dcc <unlink>
    3374:	0c051b63          	bnez	a0,344a <dirfile+0x174>
  fd = open(".", O_RDWR);
    3378:	4589                	li	a1,2
    337a:	00002517          	auipc	a0,0x2
    337e:	77650513          	addi	a0,a0,1910 # 5af0 <malloc+0x81e>
    3382:	23b010ef          	jal	4dbc <open>
  if(fd >= 0){
    3386:	0c055c63          	bgez	a0,345e <dirfile+0x188>
  fd = open(".", 0);
    338a:	4581                	li	a1,0
    338c:	00002517          	auipc	a0,0x2
    3390:	76450513          	addi	a0,a0,1892 # 5af0 <malloc+0x81e>
    3394:	229010ef          	jal	4dbc <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	0dc58593          	addi	a1,a1,220 # 5478 <malloc+0x1a6>
    33a4:	1f9010ef          	jal	4d9c <write>
    33a8:	0ca04563          	bgtz	a0,3472 <dirfile+0x19c>
  close(fd);
    33ac:	8526                	mv	a0,s1
    33ae:	1f7010ef          	jal	4da4 <close>
}
    ...
    33c4:	8e050513          	addi	a0,a0,-1824 # 6ca0 <malloc+0x19ce>
    33c8:	657010ef          	jal	521e <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	8ec50513          	addi	a0,a0,-1812 # 6cc0 <malloc+0x19ee>
    33dc:	643010ef          	jal	521e <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	90850513          	addi	a0,a0,-1784 # 6cf0 <malloc+0x1a1e>
    33f0:	62f010ef          	jal	521e <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	8f450513          	addi	a0,a0,-1804 # 6cf0 <malloc+0x1a1e>
    3404:	61b010ef          	jal	521e <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	90850513          	addi	a0,a0,-1784 # 6d18 <malloc+0x1a46>
    3418:	607010ef          	jal	521e <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	91c50513          	addi	a0,a0,-1764 # 6d40 <malloc+0x1a6e>
    342c:	5f3010ef          	jal	521e <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	93050513          	addi	a0,a0,-1744 # 6d68 <malloc+0x1a96>
    3440:	5df010ef          	jal	521e <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	94450513          	addi	a0,a0,-1724 # 6d90 <malloc+0x1abe>
    3454:	5cb010ef          	jal	521e <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	95050513          	addi	a0,a0,-1712 # 6db0 <malloc+0x1ade>
    3468:	5b7010ef          	jal	521e <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	96450513          	addi	a0,a0,-1692 # 6dd8 <malloc+0x1b06>
    347c:	5a3010ef          	jal	521e <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	950a0a13          	addi	s4,s4,-1712 # 6df0 <malloc+0x1b1e>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	45048493          	addi	s1,s1,1104 # 68f8 <malloc+0x1626>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	130a8a93          	addi	s5,s5,304 # 55e0 <malloc+0x30e>
    fd = open("xx", O_CREATE);
    34b8:	00004997          	auipc	s3,0x4
    34bc:	83098993          	addi	s3,s3,-2000 # 6ce8 <malloc+0x1a16>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	93450513          	addi	a0,a0,-1740 # 6df8 <malloc+0x1b26>
    34cc:	553010ef          	jal	521e <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	93850513          	addi	a0,a0,-1736 # 6e10 <malloc+0x1b3e>
    34e0:	53f010ef          	jal	521e <printf>
      exit(1);
    34e4:	4505                	li	a0,1
    34e6:	08f010ef          	jal	4d74 <exit>
      close(fd);
    34ea:	0bb010ef          	jal	4da4 <close>
    34ee:	a82d                	j	3528 <iref+0xa2>
    unlink("xx");
    34f0:	854e                	mv	a0,s3
    34f2:	0db010ef          	jal	4dcc <unlink>
  for(i = 0; i < NINODE + 1; i++){
    34f6:	397d                	addiw	s2,s2,-1
    34f8:	04090263          	beqz	s2,353c <iref+0xb6>
    if(mkdir("irefd") != 0){
    34fc:	8552                	mv	a0,s4
    34fe:	0e7010ef          	jal	4de4 <mkdir>
    3502:	f161                	bnez	a0,34c2 <iref+0x3c>
    if(chdir("irefd") != 0){
    3504:	8552                	mv	a0,s4
    3506:	0e7010ef          	jal	4dec <chdir>
    350a:	f571                	bnez	a0,34d6 <iref+0x50>
    mkdir("");
    350c:	8526                	mv	a0,s1
    350e:	0d7010ef          	jal	4de4 <mkdir>
    link("README", "");
    3512:	85a6                	mv	a1,s1
    3514:	8556                	mv	a0,s5
    3516:	0c7010ef          	jal	4ddc <link>
    fd = open("", O_CREATE);
    351a:	20000593          	li	a1,512
    351e:	8526                	mv	a0,s1
    3520:	09d010ef          	jal	4dbc <open>
    if(fd >= 0)
    3524:	fc0553e3          	bgez	a0,34ea <iref+0x64>
    fd = open("xx", O_CREATE);
    3528:	20000593          	li	a1,512
    352c:	854e                	mv	a0,s3
    352e:	08f010ef          	jal	4dbc <open>
    if(fd >= 0)
    3532:	fa054fe3          	bltz	a0,34f0 <iref+0x6a>
      close(fd);
    3536:	06f010ef          	jal	4da4 <close>
    353a:	bf5d                	j	34f0 <iref+0x6a>
    353c:	03300493          	li	s1,51
    chdir("..");
    3540:	00003997          	auipc	s3,0x3
    3544:	0d098993          	addi	s3,s3,208 # 6610 <malloc+0x133e>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	8a890913          	addi	s2,s2,-1880 # 6df0 <malloc+0x1b1e>
    chdir("..");
    3550:	854e                	mv	a0,s3
    3552:	09b010ef          	jal	4dec <chdir>
    unlink("irefd");
    3556:	854a                	mv	a0,s2
    3558:	075010ef          	jal	4dcc <unlink>
  for(i = 0; i < NINODE + 1; i++){
    355c:	34fd                	addiw	s1,s1,-1
    355e:	f8ed                	bnez	s1,3550 <iref+0xca>
  chdir("/");
    3560:	00003517          	auipc	a0,0x3
    3564:	05850513          	addi	a0,a0,88 # 65b8 <malloc+0x12e6>
    3568:	085010ef          	jal	4dec <chdir>
}
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	89c50513          	addi	a0,a0,-1892 # 6e28 <malloc+0x1b56>
    3594:	051010ef          	jal	4de4 <mkdir>
  ...
  if(pid == 0){
    ...
    35ac:	88050513          	addi	a0,a0,-1920 # 6e28 <malloc+0x1b56>
    35b0:	00d010ef          	jal	4dbc <open>
    if(fd >= 0){
    35b4:	04054063          	bltz	a0,35f4 <openiputtest+0x74>
      printf("%s: open directory for write succeeded\n", s);
    35b8:	85a6                	mv	a1,s1
    35ba:	00004517          	auipc	a0,0x4
    35be:	88e50513          	addi	a0,a0,-1906 # 6e48 <malloc+0x1b76>
    35c2:	45d010ef          	jal	521e <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	86250513          	addi	a0,a0,-1950 # 6e30 <malloc+0x1b5e>
    35d6:	449010ef          	jal	521e <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	6b650513          	addi	a0,a0,1718 # 5c98 <malloc+0x9c6>
    35ea:	435010ef          	jal	521e <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  pause(1);
    35fa:	4505                	li	a0,1
    35fc:	011010ef          	jal	4e0c <pause>
  if(unlink("oidir") != 0){
    3600:	00004517          	auipc	a0,0x4
    3604:	82850513          	addi	a0,a0,-2008 # 6e28 <malloc+0x1b56>
    3608:	7c4010ef          	jal	4dcc <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00003517          	auipc	a0,0x3
    3614:	87850513          	addi	a0,a0,-1928 # 5e88 <malloc+0xbb6>
    3618:	407010ef          	jal	521e <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	83250513          	addi	a0,a0,-1998 # 6e70 <malloc+0x1b9e>
    3646:	786010ef          	jal	4dcc <unlink>
  int pid = fork();
  ...
  pause(20); // two seconds
    3654:	4551                	li	a0,20
    3656:	7b6010ef          	jal	4e0c <pause>
  close(open("stopforking", O_CREATE|O_RDWR));
    365a:	20200593          	li	a1,514
    365e:	00004517          	auipc	a0,0x4
    3662:	81250513          	addi	a0,a0,-2030 # 6e70 <malloc+0x1b9e>
    3666:	756010ef          	jal	4dbc <open>
    366a:	73a010ef          	jal	4da4 <close>
  wait(0);
    366e:	4501                	li	a0,0
    3670:	70c010ef          	jal	4d7c <wait>
  pause(10); // one second
    3674:	4529                	li	a0,10
    3676:	796010ef          	jal	4e0c <pause>
}
    ...
    368a:	7d250513          	addi	a0,a0,2002 # 5e58 <malloc+0xb86>
    368e:	391010ef          	jal	521e <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	6e0010ef          	jal	4d74 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	7d848493          	addi	s1,s1,2008 # 6e70 <malloc+0x1b9e>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    36a4:	718010ef          	jal	4dbc <open>
      if(fd >= 0){
    ...
    36bc:	7b850513          	addi	a0,a0,1976 # 6e70 <malloc+0x1b9e>
    36c0:	6fc010ef          	jal	4dbc <open>
    36c4:	6e0010ef          	jal	4da4 <close>
...
00000000000036d0 <killstatus>:
{
    ...
    pause(1);
    36f4:	4505                	li	a0,1
    36f6:	716010ef          	jal	4e0c <pause>
    kill(pid1);
    36fa:	8526                	mv	a0,s1
    36fc:	6b0010ef          	jal	4dac <kill>
    wait(&xst);
  ...
  exit(0);
    ...
    3722:	57a50513          	addi	a0,a0,1402 # 5c98 <malloc+0x9c6>
    3726:	2f9010ef          	jal	521e <printf>
      exit(1);
    372a:	4505                	li	a0,1
    372c:	648010ef          	jal	4d74 <exit>
        getpid();
    3730:	6cc010ef          	jal	4dfc <getpid>
      while(1) {
    3734:	bff5                	j	3730 <killstatus+0x60>
       printf("%s: status should be -1\n", s);
    3736:	85d2                	mv	a1,s4
    3738:	00003517          	auipc	a0,0x3
    373c:	74850513          	addi	a0,a0,1864 # 6e80 <malloc+0x1bae>
    3740:	2df010ef          	jal	521e <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	6ec50513          	addi	a0,a0,1772 # 5e58 <malloc+0xb86>
    3774:	2ab010ef          	jal	521e <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	50a50513          	addi	a0,a0,1290 # 5c98 <malloc+0x9c6>
    3796:	289010ef          	jal	521e <printf>
    exit(1);
    379a:	4505                	li	a0,1
    379c:	5d8010ef          	jal	4d74 <exit>
  pipe(pfds);
    37a0:	fc840513          	addi	a0,s0,-56
    37a4:	5e8010ef          	jal	4d8c <pipe>
  pid3 = fork();
  ...
  if(pid3 == 0){
    ...
    37b8:	5ec010ef          	jal	4da4 <close>
    if(write(pfds[1], "x", 1) != 1)
    37bc:	4605                	li	a2,1
    37be:	00002597          	auipc	a1,0x2
    37c2:	cba58593          	addi	a1,a1,-838 # 5478 <malloc+0x1a6>
    37c6:	fcc42503          	lw	a0,-52(s0)
    37ca:	5d2010ef          	jal	4d9c <write>
    37ce:	4785                	li	a5,1
    37d0:	02f51163          	bne	a0,a5,37f2 <preempt+0xa8>
    close(pfds[1]);
    37d4:	fcc42503          	lw	a0,-52(s0)
    37d8:	5cc010ef          	jal	4da4 <close>
    for(;;)
    37dc:	a001                	j	37dc <preempt+0x92>
     printf("%s: fork failed\n", s);
    37de:	85ca                	mv	a1,s2
    37e0:	00002517          	auipc	a0,0x2
    37e4:	4b850513          	addi	a0,a0,1208 # 5c98 <malloc+0x9c6>
    37e8:	237010ef          	jal	521e <printf>
     exit(1);
    37ec:	4505                	li	a0,1
  ...
  close(pfds[0]);
    ...
    3844:	560010ef          	jal	4da4 <close>
  printf("kill... ");
    3848:	00003517          	auipc	a0,0x3
    384c:	68850513          	addi	a0,a0,1672 # 6ed0 <malloc+0x1bfe>
    3850:	1cf010ef          	jal	521e <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
    3856:	556010ef          	jal	4dac <kill>
  kill(pid2);
    385a:	854e                	mv	a0,s3
    385c:	550010ef          	jal	4dac <kill>
  kill(pid3);
    3860:	8552                	mv	a0,s4
    3862:	54a010ef          	jal	4dac <kill>
  printf("wait... ");
    3866:	00003517          	auipc	a0,0x3
    386a:	67a50513          	addi	a0,a0,1658 # 6ee0 <malloc+0x1c0e>
    386e:	1b1010ef          	jal	521e <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	3d250513          	addi	a0,a0,978 # 5c98 <malloc+0x9c6>
    38ce:	151010ef          	jal	521e <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	54650513          	addi	a0,a0,1350 # 5e20 <malloc+0xb4e>
    38e2:	13d010ef          	jal	521e <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	46250513          	addi	a0,a0,1122 # 5da0 <malloc+0xace>
    3946:	0d9010ef          	jal	521e <printf>
    exit(1);
    394a:	4505                	li	a0,1
    ...
    396c:	d0058593          	addi	a1,a1,-768 # 7668 <malloc+0x2396>
    3970:	fa442503          	lw	a0,-92(s0)
    3974:	428010ef          	jal	4d9c <write>
      for(;;) pause(1000);
    3978:	3e800513          	li	a0,1000
    397c:	490010ef          	jal	4e0c <pause>
    3980:	bfe5                	j	3978 <sbrkfail+0x72>
        write(fds[1], "0", 1);
    3982:	4605                	li	a2,1
    3984:	00003597          	auipc	a1,0x3
    3988:	56c58593          	addi	a1,a1,1388 # 6ef0 <malloc+0x1c1e>
    398c:	fa442503          	lw	a0,-92(s0)
    3990:	40c010ef          	jal	4d9c <write>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	52250513          	addi	a0,a0,1314 # 6ef8 <malloc+0x1c26>
    39de:	041010ef          	jal	521e <printf>
  ...
  if(pid == 0){
    ...
    3a24:	52850513          	addi	a0,a0,1320 # 6f48 <malloc+0x1c76>
    3a28:	7f6010ef          	jal	521e <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	4f450513          	addi	a0,a0,1268 # 6f28 <malloc+0x1c56>
    3a3c:	7e2010ef          	jal	521e <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	25050513          	addi	a0,a0,592 # 5c98 <malloc+0x9c6>
    3a50:	7ce010ef          	jal	521e <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	780010ef          	jal	5250 <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	7fa010ef          	jal	52d2 <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	772010ef          	jal	5250 <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	48e50513          	addi	a0,a0,1166 # 6f78 <malloc+0x1ca6>
    3af2:	72c010ef          	jal	521e <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	48a50513          	addi	a0,a0,1162 # 6f98 <malloc+0x1cc6>
    3b16:	2b6010ef          	jal	4dcc <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	47a50513          	addi	a0,a0,1146 # 6f98 <malloc+0x1cc6>
    3b26:	296010ef          	jal	4dbc <open>
  if(fd < 0){
  ...
  if(pid == 0) {
    ...
    3b8c:	42050513          	addi	a0,a0,1056 # 6fa8 <malloc+0x1cd6>
    3b90:	68e010ef          	jal	521e <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	43450513          	addi	a0,a0,1076 # 6fd0 <malloc+0x1cfe>
    3ba4:	67a010ef          	jal	521e <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  close(fd);
    3bc4:	854a                	mv	a0,s2
    3bc6:	1de010ef          	jal	4da4 <close>
  fd = open("sharedfd", 0);
    3bca:	4581                	li	a1,0
    3bcc:	00003517          	auipc	a0,0x3
    3bd0:	3cc50513          	addi	a0,a0,972 # 6f98 <malloc+0x1cc6>
    3bd4:	1e8010ef          	jal	4dbc <open>
    3bd8:	8baa                	mv	s7,a0
  nc = np = 0;
    3bda:	8ace                	mv	s5,s3
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	3ec50513          	addi	a0,a0,1004 # 6ff0 <malloc+0x1d1e>
    3c0c:	612010ef          	jal	521e <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  close(fd);
    3c2e:	855e                	mv	a0,s7
    3c30:	174010ef          	jal	4da4 <close>
  unlink("sharedfd");
    3c34:	00003517          	auipc	a0,0x3
    3c38:	36450513          	addi	a0,a0,868 # 6f98 <malloc+0x1cc6>
    3c3c:	190010ef          	jal	4dcc <unlink>
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	3c250513          	addi	a0,a0,962 # 7018 <malloc+0x1d46>
    3c5e:	5c0010ef          	jal	521e <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	3a278793          	addi	a5,a5,930 # 7030 <malloc+0x1d5e>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	39e78793          	addi	a5,a5,926 # 7038 <malloc+0x1d66>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	39a78793          	addi	a5,a5,922 # 7040 <malloc+0x1d6e>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	39678793          	addi	a5,a5,918 # 7048 <malloc+0x1d76>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f8450513          	addi	a0,a0,-124 # 5c98 <malloc+0x9c6>
    3d1c:	502010ef          	jal	521e <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	fba50513          	addi	a0,a0,-70 # 5d30 <malloc+0xa5e>
    3d7e:	4a0010ef          	jal	521e <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	7f1000ef          	jal	4d74 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	2c850513          	addi	a0,a0,712 # 7050 <malloc+0x1d7e>
    3d90:	48e010ef          	jal	521e <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	2c650513          	addi	a0,a0,710 # 7068 <malloc+0x1d96>
    3daa:	474010ef          	jal	521e <printf>
          exit(1);
    3dae:	4505                	li	a0,1
    ...
    close(fd);
    3de2:	854e                	mv	a0,s3
    3de4:	7c1000ef          	jal	4da4 <close>
    if(total != N*SZ){
    3de8:	03a91463          	bne	s2,s10,3e10 <fourfiles+0x1a2>
    unlink(fname);
    3dec:	8562                	mv	a0,s8
    3dee:	7df000ef          	jal	4dcc <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	26650513          	addi	a0,a0,614 # 7078 <malloc+0x1da6>
    3e1a:	404010ef          	jal	521e <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	224b8b93          	addi	s7,s7,548 # 7090 <malloc+0x1dbe>
  for(i = 0; i < N; i++){
    ...
    3e9a:	723000ef          	jal	4dbc <open>
      if(fd < 0){
    3e9e:	1e055063          	bgez	a0,407e <concreate+0x23c>
        printf("concreate create %s failed\n", file);
    3ea2:	fa840593          	addi	a1,s0,-88
    3ea6:	00003517          	auipc	a0,0x3
    3eaa:	1f250513          	addi	a0,a0,498 # 7098 <malloc+0x1dc6>
    3eae:	370010ef          	jal	521e <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	1d450513          	addi	a0,a0,468 # 7090 <malloc+0x1dbe>
    3ec4:	719000ef          	jal	4ddc <link>
      exit(0);
    3ec8:	4501                	li	a0,0
  ...
  fd = open(".", 0);
    ...
    3ee8:	c0c50513          	addi	a0,a0,-1012 # 5af0 <malloc+0x81e>
    3eec:	6d1000ef          	jal	4dbc <open>
    3ef0:	892a                	mv	s2,a0
  n = 0;
    3ef2:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	16450513          	addi	a0,a0,356 # 70b8 <malloc+0x1de6>
    3f5c:	2c2010ef          	jal	521e <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	16c50513          	addi	a0,a0,364 # 70d8 <malloc+0x1e06>
    3f74:	2aa010ef          	jal	521e <printf>
        exit(1);
    3f78:	4505                	li	a0,1
    3f7a:	5fb000ef          	jal	4d74 <exit>
  close(fd);
    3f7e:	854a                	mv	a0,s2
    3f80:	625000ef          	jal	4da4 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	16850513          	addi	a0,a0,360 # 7100 <malloc+0x1e2e>
    3fa0:	27e010ef          	jal	521e <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	cec50513          	addi	a0,a0,-788 # 5c98 <malloc+0x9c6>
    3fb4:	26a010ef          	jal	521e <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
    ...
    3fc4:	5f9000ef          	jal	4dbc <open>
    3fc8:	5dd000ef          	jal	4da4 <close>
      close(open(file, 0));
    3fcc:	4581                	li	a1,0
    3fce:	fa840513          	addi	a0,s0,-88
    3fd2:	5eb000ef          	jal	4dbc <open>
    3fd6:	5cf000ef          	jal	4da4 <close>
      close(open(file, 0));
    3fda:	4581                	li	a1,0
    3fdc:	fa840513          	addi	a0,s0,-88
    3fe0:	5dd000ef          	jal	4dbc <open>
    3fe4:	5c1000ef          	jal	4da4 <close>
      close(open(file, 0));
    3fe8:	4581                	li	a1,0
    3fea:	fa840513          	addi	a0,s0,-88
    3fee:	5cf000ef          	jal	4dbc <open>
    3ff2:	5b3000ef          	jal	4da4 <close>
      close(open(file, 0));
    3ff6:	4581                	li	a1,0
    3ff8:	fa840513          	addi	a0,s0,-88
    3ffc:	5c1000ef          	jal	4dbc <open>
    4000:	5a5000ef          	jal	4da4 <close>
      close(open(file, 0));
    4004:	4581                	li	a1,0
    4006:	fa840513          	addi	a0,s0,-88
    400a:	5b3000ef          	jal	4dbc <open>
    400e:	597000ef          	jal	4da4 <close>
    if(pid == 0)
  ...
  for(i = 0; i < N; i++){
    ...
    404a:	583000ef          	jal	4dcc <unlink>
      unlink(file);
    404e:	fa840513          	addi	a0,s0,-88
    4052:	57b000ef          	jal	4dcc <unlink>
      unlink(file);
    4056:	fa840513          	addi	a0,s0,-88
    405a:	573000ef          	jal	4dcc <unlink>
      unlink(file);
    405e:	fa840513          	addi	a0,s0,-88
    4062:	56b000ef          	jal	4dcc <unlink>
      unlink(file);
    4066:	fa840513          	addi	a0,s0,-88
    406a:	563000ef          	jal	4dcc <unlink>
      unlink(file);
    406e:	fa840513          	addi	a0,s0,-88
    4072:	55b000ef          	jal	4dcc <unlink>
    4076:	bf71                	j	4012 <concreate+0x1d0>
      exit(0);
    4078:	4501                	li	a0,0
    407a:	4fb000ef          	jal	4d74 <exit>
      close(fd);
    407e:	527000ef          	jal	4da4 <close>
    if(pid == 0) {
    4082:	b599                	j	3ec8 <concreate+0x86>
      close(fd);
    4084:	521000ef          	jal	4da4 <close>
      wait(&xstatus);
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	03e50513          	addi	a0,a0,62 # 7138 <malloc+0x1e66>
    4102:	4cb000ef          	jal	4dcc <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	02e50513          	addi	a0,a0,46 # 7138 <malloc+0x1e66>
    4112:	4ab000ef          	jal	4dbc <open>
    4116:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4118:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  close(fd);
    414e:	854e                	mv	a0,s3
    4150:	455000ef          	jal	4da4 <close>
  fd = open("bigfile.dat", 0);
    4154:	4581                	li	a1,0
    4156:	00003517          	auipc	a0,0x3
    415a:	fe250513          	addi	a0,a0,-30 # 7138 <malloc+0x1e66>
    415e:	45f000ef          	jal	4dbc <open>
    4162:	8a2a                	mv	s4,a0
  total = 0;
    4164:	4981                	li	s3,0
  for(i = 0; ; i++){
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f9650513          	addi	a0,a0,-106 # 7148 <malloc+0x1e76>
    41ba:	064010ef          	jal	521e <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	fa250513          	addi	a0,a0,-94 # 7168 <malloc+0x1e96>
    41ce:	050010ef          	jal	521e <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	fae50513          	addi	a0,a0,-82 # 7188 <malloc+0x1eb6>
    41e2:	03c010ef          	jal	521e <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	fba50513          	addi	a0,a0,-70 # 71a8 <malloc+0x1ed6>
    41f6:	028010ef          	jal	521e <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	fc650513          	addi	a0,a0,-58 # 71c8 <malloc+0x1ef6>
    420a:	014010ef          	jal	521e <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	fca50513          	addi	a0,a0,-54 # 71e0 <malloc+0x1f0e>
    421e:	000010ef          	jal	521e <printf>
      exit(1);
    4222:	4505                	li	a0,1
    4224:	351000ef          	jal	4d74 <exit>
  close(fd);
    4228:	8552                	mv	a0,s4
    422a:	37b000ef          	jal	4da4 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    423c:	f0050513          	addi	a0,a0,-256 # 7138 <malloc+0x1e66>
    4240:	38d000ef          	jal	4dcc <unlink>
}
    ...
    425c:	fa850513          	addi	a0,a0,-88 # 7200 <malloc+0x1f2e>
    4260:	7bf000ef          	jal	521e <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	faa50513          	addi	a0,a0,-86 # 7220 <malloc+0x1f4e>
    427e:	34f000ef          	jal	4dcc <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f8450513          	addi	a0,a0,-124 # 7220 <malloc+0x1f4e>
    42a4:	319000ef          	jal	4dbc <open>
  if(fd < 0){
    42a8:	08054663          	bltz	a0,4334 <bigargtest+0xca>
  close(fd);
    42ac:	2f9000ef          	jal	4da4 <close>
}
    ...
    42fa:	11250513          	addi	a0,a0,274 # 5408 <malloc+0x136>
    42fe:	2b7000ef          	jal	4db4 <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	f1a50513          	addi	a0,a0,-230 # 7220 <malloc+0x1f4e>
    430e:	2af000ef          	jal	4dbc <open>
    close(fd);
    4312:	293000ef          	jal	4da4 <close>
    exit(0);
    4316:	4501                	li	a0,0
    ...
    4322:	f1250513          	addi	a0,a0,-238 # 7230 <malloc+0x1f5e>
    4326:	6f9000ef          	jal	521e <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	f1a50513          	addi	a0,a0,-230 # 7250 <malloc+0x1f7e>
    433e:	6e1000ef          	jal	521e <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	ee250513          	addi	a0,a0,-286 # 7270 <malloc+0x1f9e>
    4396:	689000ef          	jal	521e <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	1d9000ef          	jal	4d74 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	ee850513          	addi	a0,a0,-280 # 7288 <malloc+0x1fb6>
    43a8:	677000ef          	jal	521e <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	e5a50513          	addi	a0,a0,-422 # 7270 <malloc+0x1f9e>
    441e:	601000ef          	jal	521e <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	151000ef          	jal	4d74 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	e8850513          	addi	a0,a0,-376 # 72b0 <malloc+0x1fde>
    4430:	5ef000ef          	jal	521e <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	e7450513          	addi	a0,a0,-396 # 72c0 <malloc+0x1fee>
    4454:	5cb000ef          	jal	521e <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	e3650513          	addi	a0,a0,-458 # 72d8 <malloc+0x2006>
    44aa:	575000ef          	jal	521e <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	0c5000ef          	jal	4d74 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	49c78793          	addi	a5,a5,1180 # 7950 <malloc+0x267e>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	0f8a0a13          	addi	s4,s4,248 # 55e0 <malloc+0x30e>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	000a8a93          	mv	s5,s5
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
    44fc:	0c1000ef          	jal	4dbc <open>
    4500:	84aa                	mv	s1,a0
    ...
    450e:	85ce                	mv	a1,s3
    4510:	085000ef          	jal	4d94 <read>
    4514:	04055663          	bgez	a0,4560 <lazy_copy+0x102>
    close(fd);
    4518:	8526                	mv	a0,s1
    451a:	08b000ef          	jal	4da4 <close>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    451e:	60200593          	li	a1,1538
    4522:	8556                	mv	a0,s5
    4524:	099000ef          	jal	4dbc <open>
    4528:	84aa                	mv	s1,a0
    ...
    4532:	85ce                	mv	a1,s3
    4534:	069000ef          	jal	4d9c <write>
    4538:	04055663          	bgez	a0,4584 <lazy_copy+0x126>
    close(fd);
    453c:	8526                	mv	a0,s1
    453e:	067000ef          	jal	4da4 <close>
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
  ...
  exit(0);
    ...
    4552:	dba50513          	addi	a0,a0,-582 # 7308 <malloc+0x2036>
    4556:	4c9000ef          	jal	521e <printf>
    455a:	4505                	li	a0,1
    455c:	019000ef          	jal	4d74 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	dc050513          	addi	a0,a0,-576 # 7320 <malloc+0x204e>
    4568:	4b7000ef          	jal	521e <printf>
    456c:	4505                	li	a0,1
    456e:	007000ef          	jal	4d74 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	dbe50513          	addi	a0,a0,-578 # 7330 <malloc+0x205e>
    457a:	4a5000ef          	jal	521e <printf>
    457e:	4505                	li	a0,1
    4580:	7f4000ef          	jal	4d74 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	dc450513          	addi	a0,a0,-572 # 7348 <malloc+0x2076>
    458c:	493000ef          	jal	521e <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d8050513          	addi	a0,a0,-640 # 7360 <malloc+0x208e>
    45e8:	437000ef          	jal	521e <printf>
    exit(1);
    45ec:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d8850513          	addi	a0,a0,-632 # 7390 <malloc+0x20be>
    4610:	40f000ef          	jal	521e <printf>
    exit(1);
    4614:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    4632:	d9a50513          	addi	a0,a0,-614 # 73c8 <malloc+0x20f6>
    4636:	3e9000ef          	jal	521e <printf>
    exit(1);
    463a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4652:	da250513          	addi	a0,a0,-606 # 73f0 <malloc+0x211e>
    4656:	3c9000ef          	jal	521e <printf>
    exit(1);
    465a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4672:	daa50513          	addi	a0,a0,-598 # 7418 <malloc+0x2146>
    4676:	3a9000ef          	jal	521e <printf>
    exit(1);
    467a:	4505                	li	a0,1
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	da650513          	addi	a0,a0,-602 # 7448 <malloc+0x2176>
    46aa:	375000ef          	jal	521e <printf>
  for(nfiles = 0; ; nfiles++){
    46ae:	4481                	li	s1,0
    name[0] = 'f';
    ...
    46c2:	d9ac8c93          	addi	s9,s9,-614 # 7458 <malloc+0x2186>
    name[0] = 'f';
    ...
    470a:	8566                	mv	a0,s9
    470c:	313000ef          	jal	521e <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    4710:	20200593          	li	a1,514
    4714:	f6040513          	addi	a0,s0,-160
    4718:	6a4000ef          	jal	4dbc <open>
    471c:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    472a:	d4250513          	addi	a0,a0,-702 # 7468 <malloc+0x2196>
    472e:	2f1000ef          	jal	521e <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4798:	cf450513          	addi	a0,a0,-780 # 7488 <malloc+0x21b6>
    479c:	283000ef          	jal	521e <printf>
}
    ...
    47e6:	c9650513          	addi	a0,a0,-874 # 7478 <malloc+0x21a6>
    47ea:	235000ef          	jal	521e <printf>
    close(fd);
    47ee:	854a                	mv	a0,s2
    47f0:	5b4000ef          	jal	4da4 <close>
    if(total == 0)
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c9450513          	addi	a0,a0,-876 # 74a0 <malloc+0x21ce>
    4814:	20b000ef          	jal	521e <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4834:	c9850513          	addi	a0,a0,-872 # 74c8 <malloc+0x21f6>
    4838:	1e7000ef          	jal	521e <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4854:	c6050513          	addi	a0,a0,-928 # 74b0 <malloc+0x21de>
    4858:	1c7000ef          	jal	521e <printf>
    exit(1);
    485c:	4505                	li	a0,1
    ...
    4870:	c6450513          	addi	a0,a0,-924 # 74d0 <malloc+0x21fe>
    4874:	1ab000ef          	jal	521e <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	c1a50513          	addi	a0,a0,-998 # 74d8 <malloc+0x2206>
    48c6:	159000ef          	jal	521e <printf>
          return -1;
    48ca:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	b9ac0c13          	addi	s8,s8,-1126 # 74f0 <malloc+0x221e>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	b98d8d93          	addi	s11,s11,-1128 # 7508 <malloc+0x2236>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	bb0d0d13          	addi	s10,s10,-1104 # 7528 <malloc+0x2256>
    ...
    49f6:	b6650513          	addi	a0,a0,-1178 # 7558 <malloc+0x2286>
    49fa:	025000ef          	jal	521e <printf>
      return 1;
    49fe:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	b1458593          	addi	a1,a1,-1260 # 7570 <malloc+0x229e>
  ...
  int continuous = 0;
    ...
    4ab4:	ad050513          	addi	a0,a0,-1328 # 7580 <malloc+0x22ae>
    4ab8:	766000ef          	jal	521e <printf>
    exit(1);
    4abc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	ae250513          	addi	a0,a0,-1310 # 75b0 <malloc+0x22de>
    4ad6:	748000ef          	jal	521e <printf>
  exit(0);
    4ada:	4501                	li	a0,0
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
    4c32:	85ca                	mv	a1,s2
    4c34:	1a0000ef          	jal	4dd4 <fstat>
    4c38:	892a                	mv	s2,a0
  close(fd);
    4c3a:	8526                	mv	a0,s1
    4c3c:	168000ef          	jal	4da4 <close>
  return r;
...
sbrk(int n) {
  ...
  return sys_sbrk(n, SBRK_EAGER);
    4d48:	4585                	li	a1,1
    4d4a:	0ba000ef          	jal	4e04 <sys_sbrk>
}
...
sbrklazy(int n) {
  ...
  return sys_sbrk(n, SBRK_LAZY);
    4d5e:	4589                	li	a1,2
    4d60:	0a4000ef          	jal	4e04 <sys_sbrk>
}
...
0000000000004e34 <mutex_acquire>:
...
0000000000004e3c <mutex_release>:
...
0000000000004e64 <ismyear>:
.global ismyear
ismyear:
 li a7, SYS_ismyear
    4e64:	02000893          	li	a7,32
 ecall
    4e68:	00000073          	ecall
 ret
    4e6c:	8082                	ret

0000000000004e6e <thread_create>:
.global thread_create
thread_create:
 li a7, SYS_thread_create
    4e6e:	02100893          	li	a7,33
 ecall
    4e72:	00000073          	ecall
 ret
    4e76:	8082                	ret

0000000000004e78 <thread_join>:
.global thread_join
thread_join:
 li a7, SYS_thread_join
    4e78:	02200893          	li	a7,34
 ecall
    4e7c:	00000073          	ecall
 ret
    4e80:	8082                	ret

0000000000004e82 <thread_exit>:
.global thread_exit
thread_exit:
 li a7, SYS_thread_exit
    4e82:	02300893          	li	a7,35
 ecall
    4e86:	00000073          	ecall
 ret
    4e8a:	8082                	ret

0000000000004e8c <thread_id>:
.global thread_id
thread_id:
 li a7, SYS_thread_id
    4e8c:	02400893          	li	a7,36
 ecall
    4e90:	00000073          	ecall
 ret
    4e94:	8082                	ret

0000000000004e96 <putc>:
...
putc(int fd, char c)
{
    4e96:	1101                	addi	sp,sp,-32
    4e98:	ec06                	sd	ra,24(sp)
    4e9a:	e822                	sd	s0,16(sp)
    4e9c:	1000                	addi	s0,sp,32
    4e9e:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4ea2:	4605                	li	a2,1
    4ea4:	fef40593          	addi	a1,s0,-17
    4ea8:	ef5ff0ef          	jal	4d9c <write>
}
    4eac:	60e2                	ld	ra,24(sp)
    4eae:	6442                	ld	s0,16(sp)
    4eb0:	6105                	addi	sp,sp,32
    4eb2:	8082                	ret

0000000000004eb4 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4eb4:	715d                	addi	sp,sp,-80
    4eb6:	e486                	sd	ra,72(sp)
    4eb8:	e0a2                	sd	s0,64(sp)
    4eba:	f84a                	sd	s2,48(sp)
    4ebc:	0880                	addi	s0,sp,80
    4ebe:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4ec0:	c299                	beqz	a3,4ec6 <printint+0x12>
    4ec2:	0805c363          	bltz	a1,4f48 <printint+0x94>
  neg = 0;
    4ec6:	4881                	li	a7,0
    4ec8:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4ed2:	b2a50513          	addi	a0,a0,-1238 # 79f8 <digits>
    4ed6:	883e                	mv	a6,a5
    4ed8:	2785                	addiw	a5,a5,1
    4eda:	02c5f733          	remu	a4,a1,a2
    4ede:	972a                	add	a4,a4,a0
    4ee0:	00074703          	lbu	a4,0(a4)
    4ee4:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4ee8:	872e                	mv	a4,a1
    4eea:	02c5d5b3          	divu	a1,a1,a2
    4eee:	0685                	addi	a3,a3,1
    4ef0:	fec773e3          	bgeu	a4,a2,4ed6 <printint+0x22>
  if(neg)
    4ef4:	00088b63          	beqz	a7,4f0a <printint+0x56>
    buf[i++] = '-';
    4ef8:	fd078793          	addi	a5,a5,-48
    4efc:	97a2                	add	a5,a5,s0
    4efe:	02d00713          	li	a4,45
    4f02:	fee78423          	sb	a4,-24(a5)
    4f06:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4f0a:	02f05a63          	blez	a5,4f3e <printint+0x8a>
    4f0e:	fc26                	sd	s1,56(sp)
    4f10:	f44e                	sd	s3,40(sp)
    4f12:	fb840713          	addi	a4,s0,-72
    4f16:	00f704b3          	add	s1,a4,a5
    4f1a:	fff70993          	addi	s3,a4,-1
    4f1e:	99be                	add	s3,s3,a5
    4f20:	37fd                	addiw	a5,a5,-1
    4f22:	1782                	slli	a5,a5,0x20
    4f24:	9381                	srli	a5,a5,0x20
    4f26:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4f2a:	fff4c583          	lbu	a1,-1(s1)
    4f2e:	854a                	mv	a0,s2
    4f30:	f67ff0ef          	jal	4e96 <putc>
  while(--i >= 0)
    4f34:	14fd                	addi	s1,s1,-1
    4f36:	ff349ae3          	bne	s1,s3,4f2a <printint+0x76>
    4f3a:	74e2                	ld	s1,56(sp)
    4f3c:	79a2                	ld	s3,40(sp)
}
    4f3e:	60a6                	ld	ra,72(sp)
    4f40:	6406                	ld	s0,64(sp)
    4f42:	7942                	ld	s2,48(sp)
    4f44:	6161                	addi	sp,sp,80
    4f46:	8082                	ret
    x = -xx;
    4f48:	40b005b3          	neg	a1,a1
    neg = 1;
    4f4c:	4885                	li	a7,1
    x = -xx;
    4f4e:	bfad                	j	4ec8 <printint+0x14>

0000000000004f50 <vprintf>:
}
...
{
    4f50:	711d                	addi	sp,sp,-96
    4f52:	ec86                	sd	ra,88(sp)
    4f54:	e8a2                	sd	s0,80(sp)
    4f56:	e0ca                	sd	s2,64(sp)
    4f58:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4f5a:	0005c903          	lbu	s2,0(a1)
    4f5e:	28090663          	beqz	s2,51ea <vprintf+0x29a>
    4f62:	e4a6                	sd	s1,72(sp)
    4f64:	fc4e                	sd	s3,56(sp)
    4f66:	f852                	sd	s4,48(sp)
    4f68:	f456                	sd	s5,40(sp)
    4f6a:	f05a                	sd	s6,32(sp)
    4f6c:	ec5e                	sd	s7,24(sp)
    4f6e:	e862                	sd	s8,16(sp)
    4f70:	e466                	sd	s9,8(sp)
    4f72:	8b2a                	mv	s6,a0
    4f74:	8a2e                	mv	s4,a1
    4f76:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4f7e:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4f82:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4f86:	06c00c93          	li	s9,108
    4f8a:	a005                	j	4faa <vprintf+0x5a>
        putc(fd, c0);
    4f8c:	85ca                	mv	a1,s2
    4f8e:	855a                	mv	a0,s6
    4f90:	f07ff0ef          	jal	4e96 <putc>
    4f94:	a019                	j	4f9a <vprintf+0x4a>
    } else if(state == '%'){
    4f96:	03598263          	beq	s3,s5,4fba <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4f9a:	2485                	addiw	s1,s1,1
    4f9c:	8726                	mv	a4,s1
    4f9e:	009a07b3          	add	a5,s4,s1
    4fa2:	0007c903          	lbu	s2,0(a5)
    4fa6:	22090a63          	beqz	s2,51da <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4faa:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4fae:	fe0994e3          	bnez	s3,4f96 <vprintf+0x46>
      if(c0 == '%'){
    4fb2:	fd579de3          	bne	a5,s5,4f8c <vprintf+0x3c>
        state = '%';
    4fb6:	89be                	mv	s3,a5
    4fb8:	b7cd                	j	4f9a <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4fba:	00ea06b3          	add	a3,s4,a4
    4fbe:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4fc2:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4fc4:	c681                	beqz	a3,4fcc <vprintf+0x7c>
    4fc6:	9752                	add	a4,a4,s4
    4fc8:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4fcc:	05878363          	beq	a5,s8,5012 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4fd0:	05978d63          	beq	a5,s9,502a <vprintf+0xda>
    ...
    4fd4:	07500713          	li	a4,117
    4fd8:	0ee78763          	beq	a5,a4,50c6 <vprintf+0x176>
    ...
    4fdc:	07800713          	li	a4,120
    4fe0:	12e78963          	beq	a5,a4,5112 <vprintf+0x1c2>
    ...
    4fe4:	07000713          	li	a4,112
    4fe8:	14e78e63          	beq	a5,a4,5144 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4fec:	06300713          	li	a4,99
    4ff0:	18e78e63          	beq	a5,a4,518c <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4ff4:	07300713          	li	a4,115
    4ff8:	1ae78463          	beq	a5,a4,51a0 <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4ffc:	02500713          	li	a4,37
    5000:	04e79563          	bne	a5,a4,504a <vprintf+0xfa>
        putc(fd, '%');
    5004:	02500593          	li	a1,37
    5008:	855a                	mv	a0,s6
    500a:	e8dff0ef          	jal	4e96 <putc>
      ...
      state = 0;
    500e:	4981                	li	s3,0
    5010:	b769                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    5012:	008b8913          	addi	s2,s7,8
    5016:	4685                	li	a3,1
    5018:	4629                	li	a2,10
    501a:	000ba583          	lw	a1,0(s7)
    501e:	855a                	mv	a0,s6
    5020:	e95ff0ef          	jal	4eb4 <printint>
    5024:	8bca                	mv	s7,s2
      state = 0;
    5026:	4981                	li	s3,0
    5028:	bf8d                	j	4f9a <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    502a:	06400793          	li	a5,100
    502e:	02f68963          	beq	a3,a5,5060 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5032:	06c00793          	li	a5,108
    5036:	04f68263          	beq	a3,a5,507a <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    503a:	07500793          	li	a5,117
    503e:	0af68063          	beq	a3,a5,50de <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    5042:	07800793          	li	a5,120
    5046:	0ef68263          	beq	a3,a5,512a <vprintf+0x1da>
        putc(fd, '%');
    504a:	02500593          	li	a1,37
    504e:	855a                	mv	a0,s6
    5050:	e47ff0ef          	jal	4e96 <putc>
        putc(fd, c0);
    5054:	85ca                	mv	a1,s2
    5056:	855a                	mv	a0,s6
    5058:	e3fff0ef          	jal	4e96 <putc>
      state = 0;
    505c:	4981                	li	s3,0
    505e:	bf35                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    5060:	008b8913          	addi	s2,s7,8
    5064:	4685                	li	a3,1
    5066:	4629                	li	a2,10
    5068:	000bb583          	ld	a1,0(s7)
    506c:	855a                	mv	a0,s6
    506e:	e47ff0ef          	jal	4eb4 <printint>
        i += 1;
    5072:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    5074:	8bca                	mv	s7,s2
      state = 0;
    5076:	4981                	li	s3,0
        i += 1;
    5078:	b70d                	j	4f9a <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    507a:	06400793          	li	a5,100
    507e:	02f60763          	beq	a2,a5,50ac <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    5082:	07500793          	li	a5,117
    5086:	06f60963          	beq	a2,a5,50f8 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    508a:	07800793          	li	a5,120
    508e:	faf61ee3          	bne	a2,a5,504a <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    5092:	008b8913          	addi	s2,s7,8
    5096:	4681                	li	a3,0
    5098:	4641                	li	a2,16
    509a:	000bb583          	ld	a1,0(s7)
    509e:	855a                	mv	a0,s6
    50a0:	e15ff0ef          	jal	4eb4 <printint>
        i += 2;
    50a4:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    50a6:	8bca                	mv	s7,s2
      state = 0;
    50a8:	4981                	li	s3,0
        i += 2;
    50aa:	bdc5                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    50ac:	008b8913          	addi	s2,s7,8
    50b0:	4685                	li	a3,1
    50b2:	4629                	li	a2,10
    50b4:	000bb583          	ld	a1,0(s7)
    50b8:	855a                	mv	a0,s6
    50ba:	dfbff0ef          	jal	4eb4 <printint>
        i += 2;
    50be:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    50c0:	8bca                	mv	s7,s2
      state = 0;
    50c2:	4981                	li	s3,0
        i += 2;
    50c4:	bdd9                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    50c6:	008b8913          	addi	s2,s7,8
    50ca:	4681                	li	a3,0
    50cc:	4629                	li	a2,10
    50ce:	000be583          	lwu	a1,0(s7)
    50d2:	855a                	mv	a0,s6
    50d4:	de1ff0ef          	jal	4eb4 <printint>
    50d8:	8bca                	mv	s7,s2
      state = 0;
    50da:	4981                	li	s3,0
    50dc:	bd7d                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    50de:	008b8913          	addi	s2,s7,8
    50e2:	4681                	li	a3,0
    50e4:	4629                	li	a2,10
    50e6:	000bb583          	ld	a1,0(s7)
    50ea:	855a                	mv	a0,s6
    50ec:	dc9ff0ef          	jal	4eb4 <printint>
        i += 1;
    50f0:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    50f2:	8bca                	mv	s7,s2
      state = 0;
    50f4:	4981                	li	s3,0
        i += 1;
    50f6:	b555                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    50f8:	008b8913          	addi	s2,s7,8
    50fc:	4681                	li	a3,0
    50fe:	4629                	li	a2,10
    5100:	000bb583          	ld	a1,0(s7)
    5104:	855a                	mv	a0,s6
    5106:	dafff0ef          	jal	4eb4 <printint>
        i += 2;
    510a:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    510c:	8bca                	mv	s7,s2
      state = 0;
    510e:	4981                	li	s3,0
        i += 2;
    5110:	b569                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    5112:	008b8913          	addi	s2,s7,8
    5116:	4681                	li	a3,0
    5118:	4641                	li	a2,16
    511a:	000be583          	lwu	a1,0(s7)
    511e:	855a                	mv	a0,s6
    5120:	d95ff0ef          	jal	4eb4 <printint>
    5124:	8bca                	mv	s7,s2
      state = 0;
    5126:	4981                	li	s3,0
    5128:	bd8d                	j	4f9a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    512a:	008b8913          	addi	s2,s7,8
    512e:	4681                	li	a3,0
    5130:	4641                	li	a2,16
    5132:	000bb583          	ld	a1,0(s7)
    5136:	855a                	mv	a0,s6
    5138:	d7dff0ef          	jal	4eb4 <printint>
        i += 1;
    513c:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    513e:	8bca                	mv	s7,s2
      state = 0;
    5140:	4981                	li	s3,0
        i += 1;
    5142:	bda1                	j	4f9a <vprintf+0x4a>
    5144:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5146:	008b8d13          	addi	s10,s7,8
    514a:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    514e:	03000593          	li	a1,48
    5152:	855a                	mv	a0,s6
    5154:	d43ff0ef          	jal	4e96 <putc>
  putc(fd, 'x');
    5158:	07800593          	li	a1,120
    515c:	855a                	mv	a0,s6
    515e:	d39ff0ef          	jal	4e96 <putc>
    5162:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5164:	00003b97          	auipc	s7,0x3
    5168:	894b8b93          	addi	s7,s7,-1900 # 79f8 <digits>
    516c:	03c9d793          	srli	a5,s3,0x3c
    5170:	97de                	add	a5,a5,s7
    5172:	0007c583          	lbu	a1,0(a5)
    5176:	855a                	mv	a0,s6
    5178:	d1fff0ef          	jal	4e96 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    517c:	0992                	slli	s3,s3,0x4
    517e:	397d                	addiw	s2,s2,-1
    5180:	fe0916e3          	bnez	s2,516c <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5184:	8bea                	mv	s7,s10
      state = 0;
    5186:	4981                	li	s3,0
    5188:	6d02                	ld	s10,0(sp)
    518a:	bd01                	j	4f9a <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    518c:	008b8913          	addi	s2,s7,8
    5190:	000bc583          	lbu	a1,0(s7)
    5194:	855a                	mv	a0,s6
    5196:	d01ff0ef          	jal	4e96 <putc>
    519a:	8bca                	mv	s7,s2
      state = 0;
    519c:	4981                	li	s3,0
    519e:	bbf5                	j	4f9a <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    51a0:	008b8993          	addi	s3,s7,8
    51a4:	000bb903          	ld	s2,0(s7)
    51a8:	00090f63          	beqz	s2,51c6 <vprintf+0x276>
        for(; *s; s++)
    51ac:	00094583          	lbu	a1,0(s2)
    51b0:	c195                	beqz	a1,51d4 <vprintf+0x284>
          putc(fd, *s);
    51b2:	855a                	mv	a0,s6
    51b4:	ce3ff0ef          	jal	4e96 <putc>
        for(; *s; s++)
    51b8:	0905                	addi	s2,s2,1
    51ba:	00094583          	lbu	a1,0(s2)
    51be:	f9f5                	bnez	a1,51b2 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    51c0:	8bce                	mv	s7,s3
      state = 0;
    51c2:	4981                	li	s3,0
    51c4:	bbd9                	j	4f9a <vprintf+0x4a>
          s = "(null)";
    51c6:	00002917          	auipc	s2,0x2
    51ca:	78290913          	addi	s2,s2,1922 # 7948 <malloc+0x2676>
        for(; *s; s++)
    51ce:	02800593          	li	a1,40
    51d2:	b7c5                	j	51b2 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    51d4:	8bce                	mv	s7,s3
      state = 0;
    51d6:	4981                	li	s3,0
    51d8:	b3c9                	j	4f9a <vprintf+0x4a>
    51da:	64a6                	ld	s1,72(sp)
    51dc:	79e2                	ld	s3,56(sp)
    51de:	7a42                	ld	s4,48(sp)
    51e0:	7aa2                	ld	s5,40(sp)
    51e2:	7b02                	ld	s6,32(sp)
    51e4:	6be2                	ld	s7,24(sp)
    51e6:	6c42                	ld	s8,16(sp)
    51e8:	6ca2                	ld	s9,8(sp)
    }
  }
}
    51ea:	60e6                	ld	ra,88(sp)
    51ec:	6446                	ld	s0,80(sp)
    51ee:	6906                	ld	s2,64(sp)
    51f0:	6125                	addi	sp,sp,96
    51f2:	8082                	ret

00000000000051f4 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    51f4:	715d                	addi	sp,sp,-80
    51f6:	ec06                	sd	ra,24(sp)
    51f8:	e822                	sd	s0,16(sp)
    51fa:	1000                	addi	s0,sp,32
    51fc:	e010                	sd	a2,0(s0)
    51fe:	e414                	sd	a3,8(s0)
    5200:	e818                	sd	a4,16(s0)
    5202:	ec1c                	sd	a5,24(s0)
    5204:	03043023          	sd	a6,32(s0)
    5208:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    520c:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5210:	8622                	mv	a2,s0
    5212:	d3fff0ef          	jal	4f50 <vprintf>
}
    5216:	60e2                	ld	ra,24(sp)
    5218:	6442                	ld	s0,16(sp)
    521a:	6161                	addi	sp,sp,80
    521c:	8082                	ret

000000000000521e <printf>:

void
printf(const char *fmt, ...)
{
    521e:	711d                	addi	sp,sp,-96
    5220:	ec06                	sd	ra,24(sp)
    5222:	e822                	sd	s0,16(sp)
    5224:	1000                	addi	s0,sp,32
    5226:	e40c                	sd	a1,8(s0)
    5228:	e810                	sd	a2,16(s0)
    522a:	ec14                	sd	a3,24(s0)
    522c:	f018                	sd	a4,32(s0)
    522e:	f41c                	sd	a5,40(s0)
    5230:	03043823          	sd	a6,48(s0)
    5234:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5238:	00840613          	addi	a2,s0,8
    523c:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5240:	85aa                	mv	a1,a0
    5242:	4505                	li	a0,1
    5244:	d0dff0ef          	jal	4f50 <vprintf>
}
    5248:	60e2                	ld	ra,24(sp)
    524a:	6442                	ld	s0,16(sp)
    524c:	6125                	addi	sp,sp,96
    524e:	8082                	ret

0000000000005250 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5250:	1141                	addi	sp,sp,-16
    5252:	e422                	sd	s0,8(sp)
    5254:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5256:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    525a:	00004797          	auipc	a5,0x4
    525e:	2367b783          	ld	a5,566(a5) # 9490 <freep>
    5262:	a02d                	j	528c <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5264:	4618                	lw	a4,8(a2)
    5266:	9f2d                	addw	a4,a4,a1
    5268:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    526c:	6398                	ld	a4,0(a5)
    526e:	6310                	ld	a2,0(a4)
    5270:	a83d                	j	52ae <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5272:	ff852703          	lw	a4,-8(a0)
    5276:	9f31                	addw	a4,a4,a2
    5278:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    527a:	ff053683          	ld	a3,-16(a0)
    527e:	a091                	j	52c2 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5280:	6398                	ld	a4,0(a5)
    5282:	00e7e463          	bltu	a5,a4,528a <free+0x3a>
    5286:	00e6ea63          	bltu	a3,a4,529a <free+0x4a>
{
    528a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    528c:	fed7fae3          	bgeu	a5,a3,5280 <free+0x30>
    5290:	6398                	ld	a4,0(a5)
    5292:	00e6e463          	bltu	a3,a4,529a <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5296:	fee7eae3          	bltu	a5,a4,528a <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    529a:	ff852583          	lw	a1,-8(a0)
    529e:	6390                	ld	a2,0(a5)
    52a0:	02059813          	slli	a6,a1,0x20
    52a4:	01c85713          	srli	a4,a6,0x1c
    52a8:	9736                	add	a4,a4,a3
    52aa:	fae60de3          	beq	a2,a4,5264 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    52ae:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    52b2:	4790                	lw	a2,8(a5)
    52b4:	02061593          	slli	a1,a2,0x20
    52b8:	01c5d713          	srli	a4,a1,0x1c
    52bc:	973e                	add	a4,a4,a5
    52be:	fae68ae3          	beq	a3,a4,5272 <free+0x22>
    p->s.ptr = bp->s.ptr;
    52c2:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    52c4:	00004717          	auipc	a4,0x4
    52c8:	1cf73623          	sd	a5,460(a4) # 9490 <freep>
}
    52cc:	6422                	ld	s0,8(sp)
    52ce:	0141                	addi	sp,sp,16
    52d0:	8082                	ret

00000000000052d2 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    52d2:	7139                	addi	sp,sp,-64
    52d4:	fc06                	sd	ra,56(sp)
    52d6:	f822                	sd	s0,48(sp)
    52d8:	f426                	sd	s1,40(sp)
    52da:	ec4e                	sd	s3,24(sp)
    52dc:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    52de:	02051493          	slli	s1,a0,0x20
    52e2:	9081                	srli	s1,s1,0x20
    52e4:	04bd                	addi	s1,s1,15
    52e6:	8091                	srli	s1,s1,0x4
    52e8:	0014899b          	addiw	s3,s1,1
    52ec:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    52ee:	00004517          	auipc	a0,0x4
    52f2:	1a253503          	ld	a0,418(a0) # 9490 <freep>
    52f6:	c915                	beqz	a0,532a <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    52f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    52fa:	4798                	lw	a4,8(a5)
    52fc:	08977a63          	bgeu	a4,s1,5390 <malloc+0xbe>
    5300:	f04a                	sd	s2,32(sp)
    5302:	e852                	sd	s4,16(sp)
    5304:	e456                	sd	s5,8(sp)
    5306:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5308:	8a4e                	mv	s4,s3
    530a:	0009871b          	sext.w	a4,s3
    530e:	6685                	lui	a3,0x1
    5310:	00d77363          	bgeu	a4,a3,5316 <malloc+0x44>
    5314:	6a05                	lui	s4,0x1
    5316:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    531a:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    531e:	00004917          	auipc	s2,0x4
    5322:	17290913          	addi	s2,s2,370 # 9490 <freep>
  if(p == SBRK_ERROR)
    5326:	5afd                	li	s5,-1
    5328:	a081                	j	5368 <malloc+0x96>
    532a:	f04a                	sd	s2,32(sp)
    532c:	e852                	sd	s4,16(sp)
    532e:	e456                	sd	s5,8(sp)
    5330:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5332:	0000b797          	auipc	a5,0xb
    5336:	98678793          	addi	a5,a5,-1658 # fcb8 <base>
    533a:	00004717          	auipc	a4,0x4
    533e:	14f73b23          	sd	a5,342(a4) # 9490 <freep>
    5342:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5344:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5348:	b7c1                	j	5308 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    534a:	6398                	ld	a4,0(a5)
    534c:	e118                	sd	a4,0(a0)
    534e:	a8a9                	j	53a8 <malloc+0xd6>
  hp->s.size = nu;
    5350:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5354:	0541                	addi	a0,a0,16
    5356:	efbff0ef          	jal	5250 <free>
  return freep;
    535a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    535e:	c12d                	beqz	a0,53c0 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5360:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5362:	4798                	lw	a4,8(a5)
    5364:	02977263          	bgeu	a4,s1,5388 <malloc+0xb6>
    if(p == freep)
    5368:	00093703          	ld	a4,0(s2)
    536c:	853e                	mv	a0,a5
    536e:	fef719e3          	bne	a4,a5,5360 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5372:	8552                	mv	a0,s4
    5374:	9cdff0ef          	jal	4d40 <sbrk>
  if(p == SBRK_ERROR)
    5378:	fd551ce3          	bne	a0,s5,5350 <malloc+0x7e>
        return 0;
    537c:	4501                	li	a0,0
    537e:	7902                	ld	s2,32(sp)
    5380:	6a42                	ld	s4,16(sp)
    5382:	6aa2                	ld	s5,8(sp)
    5384:	6b02                	ld	s6,0(sp)
    5386:	a03d                	j	53b4 <malloc+0xe2>
    5388:	7902                	ld	s2,32(sp)
    538a:	6a42                	ld	s4,16(sp)
    538c:	6aa2                	ld	s5,8(sp)
    538e:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5390:	fae48de3          	beq	s1,a4,534a <malloc+0x78>
        p->s.size -= nunits;
    5394:	4137073b          	subw	a4,a4,s3
    5398:	c798                	sw	a4,8(a5)
        p += p->s.size;
    539a:	02071693          	slli	a3,a4,0x20
    539e:	01c6d713          	srli	a4,a3,0x1c
    53a2:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    53a4:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    53a8:	00004717          	auipc	a4,0x4
    53ac:	0ea73423          	sd	a0,232(a4) # 9490 <freep>
      return (void*)(p + 1);
    53b0:	01078513          	addi	a0,a5,16
  }
}
    53b4:	70e2                	ld	ra,56(sp)
    53b6:	7442                	ld	s0,48(sp)
    53b8:	74a2                	ld	s1,40(sp)
    53ba:	69e2                	ld	s3,24(sp)
    53bc:	6121                	addi	sp,sp,64
    53be:	8082                	ret
    53c0:	7902                	ld	s2,32(sp)
    53c2:	6a42                	ld	s4,16(sp)
    53c4:	6aa2                	ld	s5,8(sp)
    53c6:	6b02                	ld	s6,0(sp)
    53c8:	b7f5                	j	53b4 <malloc+0xe2>
